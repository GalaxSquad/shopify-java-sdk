...
*/
public class ReturnEdge extends AbstractResponse<ReturnEdge> {
    public ReturnEdge() {
    }

    public ReturnEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ReturnEdge setCursor(String arg) {
    ...
    */
    ...
    public Return getNode() {
        return (Return) get("node");
    }

    public ReturnEdge setNode(Return arg) {
