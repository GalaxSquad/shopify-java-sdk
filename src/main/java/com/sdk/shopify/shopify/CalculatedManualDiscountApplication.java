...
*/
public class CalculatedManualDiscountApplication extends AbstractResponse<CalculatedManualDiscountApplication> implements CalculatedDiscountApplication {
    public CalculatedManualDiscountApplication() {
    }

    public CalculatedManualDiscountApplication(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CalculatedManualDiscountApplication";
    }
    ...
    */
    ...
    public CalculatedManualDiscountApplication setAllocationMethod(DiscountApplicationAllocationMethod arg) {
    ...
    */
    ...
    public CalculatedManualDiscountApplication setAppliedTo(DiscountApplicationLevel arg) {
    ...
    */
    ...
    public CalculatedManualDiscountApplication setDescription(String arg) {
    ...
    */
    ...
    public CalculatedManualDiscountApplication setId(ID arg) {
    ...
    */
    ...
    public CalculatedManualDiscountApplication setTargetSelection(DiscountApplicationTargetSelection arg) {
    ...
    */
    ...
    public CalculatedManualDiscountApplication setTargetType(DiscountApplicationTargetType arg) {
    ...
    */
    ...
    public CalculatedManualDiscountApplication setValue(PricingValue arg) {
