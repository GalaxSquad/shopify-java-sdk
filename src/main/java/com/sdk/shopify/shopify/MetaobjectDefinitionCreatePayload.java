...
*/
public class MetaobjectDefinitionCreatePayload extends AbstractResponse<MetaobjectDefinitionCreatePayload> {
    public MetaobjectDefinitionCreatePayload() {
    }

    public MetaobjectDefinitionCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MetaobjectDefinitionCreatePayload setMetaobjectDefinition(MetaobjectDefinition arg) {
    ...
    */
    ...
    public MetaobjectDefinitionCreatePayload setUserErrors(List<MetaobjectUserError> arg) {
