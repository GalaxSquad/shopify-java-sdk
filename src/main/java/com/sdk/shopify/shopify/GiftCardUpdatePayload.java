...
*/
public class GiftCardUpdatePayload extends AbstractResponse<GiftCardUpdatePayload> {
    public GiftCardUpdatePayload() {
    }

    public GiftCardUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public GiftCardUpdatePayload setGiftCard(GiftCard arg) {
    ...
    */
    ...
    public GiftCardUpdatePayload setUserErrors(List<UserError> arg) {
