...
*/
public class SubscriptionContractEdge extends AbstractResponse<SubscriptionContractEdge> {
    public SubscriptionContractEdge() {
    }

    public SubscriptionContractEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SubscriptionContractEdge setCursor(String arg) {
    ...
    */
    ...
    public SubscriptionContract getNode() {
        return (SubscriptionContract) get("node");
    }

    public SubscriptionContractEdge setNode(SubscriptionContract arg) {
