...
*/
public class FulfillmentOrderAcceptFulfillmentRequestPayload extends AbstractResponse<FulfillmentOrderAcceptFulfillmentRequestPayload> {
    public FulfillmentOrderAcceptFulfillmentRequestPayload() {
    }

    public FulfillmentOrderAcceptFulfillmentRequestPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "FulfillmentOrderAcceptFulfillmentRequestPayload";
    }
    ...
    */
    ...
    public FulfillmentOrderAcceptFulfillmentRequestPayload setFulfillmentOrder(FulfillmentOrder arg) {
    ...
    */
    ...
    public FulfillmentOrderAcceptFulfillmentRequestPayload setUserErrors(List<UserError> arg) {
