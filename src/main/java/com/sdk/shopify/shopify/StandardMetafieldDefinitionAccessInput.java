...
public class StandardMetafieldDefinitionAccessInput implements Serializable {
    ...
    public StandardMetafieldDefinitionAccessInput setAdmin(MetafieldAdminAccessInput admin) {
        this.admin = Input.optional(admin);
        return this;
    }

    public StandardMetafieldDefinitionAccessInput setAdminInput(Input<MetafieldAdminAccessInput> admin) {
        if (admin == null) {
    ...
    public StandardMetafieldDefinitionAccessInput setStorefront(MetafieldStorefrontAccessInput storefront) {
        this.storefront = Input.optional(storefront);
        return this;
    }

    public StandardMetafieldDefinitionAccessInput setStorefrontInput(Input<MetafieldStorefrontAccessInput> storefront) {
        if (storefront == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public StandardMetafieldDefinitionAccessInput setCustomerAccount(MetafieldCustomerAccountAccessInput customerAccount) {
        this.customerAccount = Input.optional(customerAccount);
        return this;
    }

    public StandardMetafieldDefinitionAccessInput setCustomerAccountInput(Input<MetafieldCustomerAccountAccessInput> customerAccount) {
