...
*/
public class DiscountAutomaticBxgyCreatePayload extends AbstractResponse<DiscountAutomaticBxgyCreatePayload> {
    public DiscountAutomaticBxgyCreatePayload() {
    }

    public DiscountAutomaticBxgyCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountAutomaticBxgyCreatePayload";
    }
    ...
    */
    ...
    public DiscountAutomaticBxgyCreatePayload setAutomaticDiscountNode(DiscountAutomaticNode arg) {
    ...
    */
    ...
    public DiscountAutomaticBxgyCreatePayload setUserErrors(List<DiscountUserError> arg) {
