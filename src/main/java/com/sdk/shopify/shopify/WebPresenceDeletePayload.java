...
*/
public class WebPresenceDeletePayload extends AbstractResponse<WebPresenceDeletePayload> {
    public WebPresenceDeletePayload() {
    }

    public WebPresenceDeletePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "WebPresenceDeletePayload";
    }
    ...
    */
    ...
    public WebPresenceDeletePayload setDeletedId(ID arg) {
    ...
    */
    ...
    public WebPresenceDeletePayload setUserErrors(List<MarketUserError> arg) {
