...
*/
public class DiscountCodeBxgyCreatePayload extends AbstractResponse<DiscountCodeBxgyCreatePayload> {
    public DiscountCodeBxgyCreatePayload() {
    }

    public DiscountCodeBxgyCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeBxgyCreatePayload";
    }
    ...
    */
    ...
    public DiscountCodeBxgyCreatePayload setCodeDiscountNode(DiscountCodeNode arg) {
    ...
    */
    ...
    public DiscountCodeBxgyCreatePayload setUserErrors(List<DiscountUserError> arg) {
