...
*/
public class SubscriptionBillingCycleEditsDeletePayload extends AbstractResponse<SubscriptionBillingCycleEditsDeletePayload> {
    public SubscriptionBillingCycleEditsDeletePayload() {
    }

    public SubscriptionBillingCycleEditsDeletePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SubscriptionBillingCycleEditsDeletePayload setBillingCycles(List<SubscriptionBillingCycle> arg) {
    ...
    */
    ...
    public SubscriptionBillingCycleEditsDeletePayload setUserErrors(List<SubscriptionBillingCycleUserError> arg) {
