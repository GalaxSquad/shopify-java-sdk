...
*/
public class PublishableUnpublishToCurrentChannelPayload extends AbstractResponse<PublishableUnpublishToCurrentChannelPayload> {
    public PublishableUnpublishToCurrentChannelPayload() {
    }

    public PublishableUnpublishToCurrentChannelPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public PublishableUnpublishToCurrentChannelPayload setPublishable(Publishable arg) {
    ...
    */
    ...
    public PublishableUnpublishToCurrentChannelPayload setShop(Shop arg) {
    ...
    */
    ...
    public PublishableUnpublishToCurrentChannelPayload setUserErrors(List<UserError> arg) {
