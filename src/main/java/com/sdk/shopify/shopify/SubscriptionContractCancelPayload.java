...
*/
public class SubscriptionContractCancelPayload extends AbstractResponse<SubscriptionContractCancelPayload> {
    public SubscriptionContractCancelPayload() {
    }

    public SubscriptionContractCancelPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "SubscriptionContractCancelPayload";
    }
    ...
    */
    ...
    public SubscriptionContractCancelPayload setContract(SubscriptionContract arg) {
    ...
    */
    ...
    public SubscriptionContractCancelPayload setUserErrors(List<SubscriptionContractStatusUpdateUserError> arg) {
