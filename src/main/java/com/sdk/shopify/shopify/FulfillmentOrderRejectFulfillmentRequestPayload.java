...
*/
public class FulfillmentOrderRejectFulfillmentRequestPayload extends AbstractResponse<FulfillmentOrderRejectFulfillmentRequestPayload> {
    public FulfillmentOrderRejectFulfillmentRequestPayload() {
    }

    public FulfillmentOrderRejectFulfillmentRequestPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "FulfillmentOrderRejectFulfillmentRequestPayload";
    }
    ...
    */
    ...
    public FulfillmentOrderRejectFulfillmentRequestPayload setFulfillmentOrder(FulfillmentOrder arg) {
    ...
    */
    ...
    public FulfillmentOrderRejectFulfillmentRequestPayload setUserErrors(List<UserError> arg) {
