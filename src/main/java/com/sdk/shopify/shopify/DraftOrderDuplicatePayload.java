...
*/
public class DraftOrderDuplicatePayload extends AbstractResponse<DraftOrderDuplicatePayload> {
    public DraftOrderDuplicatePayload() {
    }

    public DraftOrderDuplicatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DraftOrderDuplicatePayload";
    }
    ...
    */
    ...
    public DraftOrderDuplicatePayload setDraftOrder(DraftOrder arg) {
    ...
    */
    ...
    public DraftOrderDuplicatePayload setUserErrors(List<UserError> arg) {
