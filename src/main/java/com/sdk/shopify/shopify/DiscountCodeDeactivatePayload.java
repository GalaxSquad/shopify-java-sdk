...
*/
public class DiscountCodeDeactivatePayload extends AbstractResponse<DiscountCodeDeactivatePayload> {
    public DiscountCodeDeactivatePayload() {
    }

    public DiscountCodeDeactivatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeDeactivatePayload";
    }
    ...
    */
    ...
    public DiscountCodeDeactivatePayload setCodeDiscountNode(DiscountCodeNode arg) {
    ...
    */
    ...
    public DiscountCodeDeactivatePayload setUserErrors(List<DiscountUserError> arg) {
