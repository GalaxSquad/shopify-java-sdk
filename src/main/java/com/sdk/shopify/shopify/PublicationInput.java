...
public class PublicationInput implements Serializable {
    ...
    public PublicationInput setPublicationId(ID publicationId) {
        this.publicationId = Input.optional(publicationId);
        return this;
    }

    public PublicationInput setPublicationIdInput(Input<ID> publicationId) {
    ...
    public PublicationInput setPublishDate(String publishDate) {
        this.publishDate = Input.optional(publishDate);
        return this;
    }

    public PublicationInput setPublishDateInput(Input<String> publishDate) {
        if (publishDate == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
