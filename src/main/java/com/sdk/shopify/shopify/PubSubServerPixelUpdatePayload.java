...
*/
public class PubSubServerPixelUpdatePayload extends AbstractResponse<PubSubServerPixelUpdatePayload> {
    public PubSubServerPixelUpdatePayload() {
    }

    public PubSubServerPixelUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "PubSubServerPixelUpdatePayload";
    }
    ...
    */
    ...
    public PubSubServerPixelUpdatePayload setServerPixel(ServerPixel arg) {
    ...
    */
    ...
    public PubSubServerPixelUpdatePayload setUserErrors(List<ErrorsServerPixelUserError> arg) {
