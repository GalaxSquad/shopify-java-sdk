...
*/
public class DraftOrderUpdatePayload extends AbstractResponse<DraftOrderUpdatePayload> {
    public DraftOrderUpdatePayload() {
    }

    public DraftOrderUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public DraftOrderUpdatePayload setDraftOrder(DraftOrder arg) {
    ...
    */
    ...
    public DraftOrderUpdatePayload setUserErrors(List<UserError> arg) {
