...
*/
public class DiscountCodeFreeShipping extends AbstractResponse<DiscountCodeFreeShipping> implements Discount, DiscountCode {
    public DiscountCodeFreeShipping() {
    }

    public DiscountCodeFreeShipping(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public DiscountCodeFreeShipping setAppliesOnOneTimePurchase(Boolean arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setAppliesOnSubscription(Boolean arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setAppliesOncePerCustomer(Boolean arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setAsyncUsageCount(Integer arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setCodes(DiscountRedeemCodeConnection arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setCodesCount(Count arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setCombinesWith(DiscountCombinesWith arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setCreatedAt(String arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setCustomerSelection(DiscountCustomerSelection arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setDestinationSelection(DiscountShippingDestinationSelection arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setEndsAt(String arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setHasTimelineComment(Boolean arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setMaximumShippingPrice(MoneyV2 arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setMinimumRequirement(DiscountMinimumRequirement arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setRecurringCycleLimit(Integer arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setShareableUrls(List<DiscountShareableUrl> arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setShortSummary(String arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setStartsAt(String arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setStatus(DiscountStatus arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setSummary(String arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setTitle(String arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setTotalSales(MoneyV2 arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setUpdatedAt(String arg) {
    ...
    */
    ...
    public DiscountCodeFreeShipping setUsageLimit(Integer arg) {
