...
*/
public class PriceListDeletePayload extends AbstractResponse<PriceListDeletePayload> {
    public PriceListDeletePayload() {
    }

    public PriceListDeletePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public PriceListDeletePayload setDeletedId(ID arg) {
    ...
    */
    ...
    public PriceListDeletePayload setUserErrors(List<PriceListUserError> arg) {
