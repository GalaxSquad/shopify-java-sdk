...
*/
public class SubscriptionBillingCycleBulkSearchPayload extends AbstractResponse<SubscriptionBillingCycleBulkSearchPayload> {
    public SubscriptionBillingCycleBulkSearchPayload() {
    }

    public SubscriptionBillingCycleBulkSearchPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "SubscriptionBillingCycleBulkSearchPayload";
    }
    ...
    */
    ...
    public SubscriptionBillingCycleBulkSearchPayload setJob(Job arg) {
    ...
    */
    ...
    public SubscriptionBillingCycleBulkSearchPayload setUserErrors(List<SubscriptionBillingCycleBulkUserError> arg) {
