...
*/
public class CheckoutBrandingOrderSummarySection extends AbstractResponse<CheckoutBrandingOrderSummarySection> {
    public CheckoutBrandingOrderSummarySection() {
    }

    public CheckoutBrandingOrderSummarySection(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CheckoutBrandingOrderSummarySection setBackground(CheckoutBrandingBackground arg) {
    ...
    */
    ...
    public CheckoutBrandingOrderSummarySection setBorder(CheckoutBrandingSimpleBorder arg) {
    ...
    */
    ...
    public CheckoutBrandingOrderSummarySection setBorderStyle(CheckoutBrandingBorderStyle arg) {
    ...
    */
    ...
    public CheckoutBrandingOrderSummarySection setBorderWidth(CheckoutBrandingBorderWidth arg) {
    ...
    */
    ...
    public CheckoutBrandingOrderSummarySection setColorScheme(CheckoutBrandingColorSchemeSelection arg) {
    ...
    */
    ...
    public CheckoutBrandingOrderSummarySection setCornerRadius(CheckoutBrandingCornerRadius arg) {
    ...
    */
    ...
    public CheckoutBrandingOrderSummarySection setPadding(CheckoutBrandingSpacingKeyword arg) {
    ...
    */
    ...
    public CheckoutBrandingOrderSummarySection setShadow(CheckoutBrandingShadow arg) {
