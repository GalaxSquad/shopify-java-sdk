...
*/
public class ProductUpdatePayload extends AbstractResponse<ProductUpdatePayload> {
    public ProductUpdatePayload() {
    }

    public ProductUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ProductUpdatePayload setProduct(Product arg) {
    ...
    */
    ...
    public ProductUpdatePayload setUserErrors(List<UserError> arg) {
