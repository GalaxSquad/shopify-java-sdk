...
*/
public class DiscountAutomaticNodeQuery extends Query<DiscountAutomaticNodeQuery> {
    DiscountAutomaticNodeQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public DiscountAutomaticNodeQuery automaticDiscount(DiscountAutomaticQueryDefinition queryDef) {
    ...
    */
    public DiscountAutomaticNodeQuery events(EventConnectionQueryDefinition queryDef) {
    ...
    * The paginated list of events associated with the host subject.
    */
    public DiscountAutomaticNodeQuery events(EventsArgumentsDefinition argsDef, EventConnectionQueryDefinition queryDef) {
        startField("events");
    ...
    */
    public DiscountAutomaticNodeQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public DiscountAutomaticNodeQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public DiscountAutomaticNodeQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public DiscountAutomaticNodeQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
