...
*/
public class ShopLocaleUpdatePayload extends AbstractResponse<ShopLocaleUpdatePayload> {
    public ShopLocaleUpdatePayload() {
    }

    public ShopLocaleUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ShopLocaleUpdatePayload setShopLocale(ShopLocale arg) {
    ...
    */
    ...
    public ShopLocaleUpdatePayload setUserErrors(List<UserError> arg) {
