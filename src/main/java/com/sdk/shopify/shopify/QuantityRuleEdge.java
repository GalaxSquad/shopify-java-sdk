...
*/
public class QuantityRuleEdge extends AbstractResponse<QuantityRuleEdge> {
    public QuantityRuleEdge() {
    }

    public QuantityRuleEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public QuantityRuleEdge setCursor(String arg) {
    ...
    */
    ...
    public QuantityRule getNode() {
        return (QuantityRule) get("node");
    }

    public QuantityRuleEdge setNode(QuantityRule arg) {
