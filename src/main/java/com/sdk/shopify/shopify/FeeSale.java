...
*/
public class FeeSale extends AbstractResponse<FeeSale> implements Sale {
    public FeeSale() {
    }

    public FeeSale(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public FeeSale setActionType(SaleActionType arg) {
    ...
    */
    ...
    public FeeSale setLineType(SaleLineType arg) {
    ...
    */
    ...
    public FeeSale setQuantity(Integer arg) {
    ...
    */
    ...
    public FeeSale setTaxes(List<SaleTax> arg) {
    ...
    */
    ...
    public FeeSale setTotalAmount(MoneyBag arg) {
    ...
    */
    ...
    public FeeSale setTotalDiscountAmountAfterTaxes(MoneyBag arg) {
    ...
    */
    ...
    public FeeSale setTotalDiscountAmountBeforeTaxes(MoneyBag arg) {
    ...
    */
    ...
    public FeeSale setTotalTaxAmount(MoneyBag arg) {
