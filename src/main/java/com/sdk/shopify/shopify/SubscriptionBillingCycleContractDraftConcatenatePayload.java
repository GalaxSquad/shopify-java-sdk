...
*/
public class SubscriptionBillingCycleContractDraftConcatenatePayload extends AbstractResponse<SubscriptionBillingCycleContractDraftConcatenatePayload> {
    public SubscriptionBillingCycleContractDraftConcatenatePayload() {
    }

    public SubscriptionBillingCycleContractDraftConcatenatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "SubscriptionBillingCycleContractDraftConcatenatePayload";
    }
    ...
    */
    ...
    public SubscriptionBillingCycleContractDraftConcatenatePayload setDraft(SubscriptionDraft arg) {
    ...
    */
    ...
    public SubscriptionBillingCycleContractDraftConcatenatePayload setUserErrors(List<SubscriptionDraftUserError> arg) {
