...
*/
public class AppInstallationEdge extends AbstractResponse<AppInstallationEdge> {
    public AppInstallationEdge() {
    }

    public AppInstallationEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AppInstallationEdge setCursor(String arg) {
    ...
    */
    ...
    public AppInstallation getNode() {
        return (AppInstallation) get("node");
    }

    public AppInstallationEdge setNode(AppInstallation arg) {
