...
*/
public class SubscriptionDraftFreeShippingDiscountUpdatePayload extends AbstractResponse<SubscriptionDraftFreeShippingDiscountUpdatePayload> {
    public SubscriptionDraftFreeShippingDiscountUpdatePayload() {
    }

    public SubscriptionDraftFreeShippingDiscountUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SubscriptionDraftFreeShippingDiscountUpdatePayload setDiscountUpdated(SubscriptionManualDiscount arg) {
    ...
    */
    ...
    public SubscriptionDraftFreeShippingDiscountUpdatePayload setDraft(SubscriptionDraft arg) {
    ...
    */
    ...
    public SubscriptionDraftFreeShippingDiscountUpdatePayload setUserErrors(List<SubscriptionDraftUserError> arg) {
