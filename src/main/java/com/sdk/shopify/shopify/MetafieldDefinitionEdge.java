...
*/
public class MetafieldDefinitionEdge extends AbstractResponse<MetafieldDefinitionEdge> {
    public MetafieldDefinitionEdge() {
    }

    public MetafieldDefinitionEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MetafieldDefinitionEdge setCursor(String arg) {
    ...
    */
    ...
    public MetafieldDefinition getNode() {
        return (MetafieldDefinition) get("node");
    }

    public MetafieldDefinitionEdge setNode(MetafieldDefinition arg) {
