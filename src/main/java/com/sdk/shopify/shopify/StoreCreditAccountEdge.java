...
*/
public class StoreCreditAccountEdge extends AbstractResponse<StoreCreditAccountEdge> {
    public StoreCreditAccountEdge() {
    }

    public StoreCreditAccountEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public StoreCreditAccountEdge setCursor(String arg) {
    ...
    */
    ...
    public StoreCreditAccount getNode() {
        return (StoreCreditAccount) get("node");
    }

    public StoreCreditAccountEdge setNode(StoreCreditAccount arg) {
