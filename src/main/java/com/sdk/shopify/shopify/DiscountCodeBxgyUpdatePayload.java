...
*/
public class DiscountCodeBxgyUpdatePayload extends AbstractResponse<DiscountCodeBxgyUpdatePayload> {
    public DiscountCodeBxgyUpdatePayload() {
    }

    public DiscountCodeBxgyUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeBxgyUpdatePayload";
    }
    ...
    */
    ...
    public DiscountCodeBxgyUpdatePayload setCodeDiscountNode(DiscountCodeNode arg) {
    ...
    */
    ...
    public DiscountCodeBxgyUpdatePayload setUserErrors(List<DiscountUserError> arg) {
