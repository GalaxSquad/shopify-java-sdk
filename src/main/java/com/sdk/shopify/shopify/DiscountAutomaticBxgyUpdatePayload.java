...
*/
public class DiscountAutomaticBxgyUpdatePayload extends AbstractResponse<DiscountAutomaticBxgyUpdatePayload> {
    public DiscountAutomaticBxgyUpdatePayload() {
    }

    public DiscountAutomaticBxgyUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountAutomaticBxgyUpdatePayload";
    }
    ...
    */
    ...
    public DiscountAutomaticBxgyUpdatePayload setAutomaticDiscountNode(DiscountAutomaticNode arg) {
    ...
    */
    ...
    public DiscountAutomaticBxgyUpdatePayload setUserErrors(List<DiscountUserError> arg) {
