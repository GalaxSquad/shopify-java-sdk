...
*/
public class MarketsB2BEntitlement extends AbstractResponse<MarketsB2BEntitlement> {
    public MarketsB2BEntitlement() {
    }

    public MarketsB2BEntitlement(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MarketsB2BEntitlement setCatalogs(MarketsCatalogsEntitlement arg) {
    ...
    */
    ...
    public MarketsB2BEntitlement setEnabled(Boolean arg) {
