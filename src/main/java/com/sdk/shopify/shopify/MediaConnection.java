...
*/
public class MediaConnection extends AbstractResponse<MediaConnection> {
    ...
    */
    ...
    /**
    * A list of nodes that are contained in MediaEdge. You can fetch data about an individual node, or you
