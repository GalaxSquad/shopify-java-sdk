...
*/
public class CompanyAssignMainContactPayload extends AbstractResponse<CompanyAssignMainContactPayload> {
    public CompanyAssignMainContactPayload() {
    }

    public CompanyAssignMainContactPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CompanyAssignMainContactPayload";
    }
    ...
    */
    ...
    public CompanyAssignMainContactPayload setCompany(Company arg) {
    ...
    */
    ...
    public CompanyAssignMainContactPayload setUserErrors(List<BusinessCustomerUserError> arg) {
