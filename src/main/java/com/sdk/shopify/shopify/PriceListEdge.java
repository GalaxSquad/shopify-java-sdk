...
*/
public class PriceListEdge extends AbstractResponse<PriceListEdge> {
    public PriceListEdge() {
    }

    public PriceListEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public PriceListEdge setCursor(String arg) {
    ...
    */
    ...
    public PriceList getNode() {
        return (PriceList) get("node");
    }

    public PriceListEdge setNode(PriceList arg) {
