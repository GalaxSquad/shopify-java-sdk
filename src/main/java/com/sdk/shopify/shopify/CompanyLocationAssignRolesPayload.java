...
*/
public class CompanyLocationAssignRolesPayload extends AbstractResponse<CompanyLocationAssignRolesPayload> {
    public CompanyLocationAssignRolesPayload() {
    }

    public CompanyLocationAssignRolesPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CompanyLocationAssignRolesPayload setRoleAssignments(List<CompanyContactRoleAssignment> arg) {
    ...
    */
    ...
    public CompanyLocationAssignRolesPayload setUserErrors(List<BusinessCustomerUserError> arg) {
