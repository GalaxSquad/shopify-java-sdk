...
*/
public class GiftCardTransactionQuery extends Query<GiftCardTransactionQuery> {
    GiftCardTransactionQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public GiftCardTransactionQuery amount(MoneyV2QueryDefinition queryDef) {
        startField("amount");
    ...
    */
    public GiftCardTransactionQuery giftCard(GiftCardQueryDefinition queryDef) {
        startField("giftCard");
    ...
    */
    public GiftCardTransactionQuery id() {
        startField("id");
    ...
    */
    public GiftCardTransactionQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public GiftCardTransactionQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public GiftCardTransactionQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public GiftCardTransactionQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
    ...
    */
    public GiftCardTransactionQuery note() {
        startField("note");
    ...
    */
    public GiftCardTransactionQuery processedAt() {
        startField("processedAt");

        return this;
    }

    public GiftCardTransactionQuery onGiftCardCreditTransaction(GiftCardCreditTransactionQueryDefinition queryDef) {
    ...
    public GiftCardTransactionQuery onGiftCardDebitTransaction(GiftCardDebitTransactionQueryDefinition queryDef) {
