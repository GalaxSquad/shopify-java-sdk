...
*/
public class DiscountAutomaticBulkDeletePayload extends AbstractResponse<DiscountAutomaticBulkDeletePayload> {
    public DiscountAutomaticBulkDeletePayload() {
    }

    public DiscountAutomaticBulkDeletePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountAutomaticBulkDeletePayload";
    }
    ...
    */
    ...
    public DiscountAutomaticBulkDeletePayload setJob(Job arg) {
    ...
    */
    ...
    public DiscountAutomaticBulkDeletePayload setUserErrors(List<DiscountUserError> arg) {
