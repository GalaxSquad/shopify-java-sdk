...
public class ProductVariantIdentifierInput implements Serializable {
    ...
    public ProductVariantIdentifierInput setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public ProductVariantIdentifierInput setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public ProductVariantIdentifierInput setCustomId(UniqueMetafieldValueInput customId) {
        this.customId = Input.optional(customId);
        return this;
    }

    public ProductVariantIdentifierInput setCustomIdInput(Input<UniqueMetafieldValueInput> customId) {
        if (customId == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
