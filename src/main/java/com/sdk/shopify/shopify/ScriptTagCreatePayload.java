...
*/
public class ScriptTagCreatePayload extends AbstractResponse<ScriptTagCreatePayload> {
    public ScriptTagCreatePayload() {
    }

    public ScriptTagCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ScriptTagCreatePayload setScriptTag(ScriptTag arg) {
    ...
    */
    ...
    public ScriptTagCreatePayload setUserErrors(List<UserError> arg) {
