...
*/
public class CompanyLocationEdge extends AbstractResponse<CompanyLocationEdge> {
    public CompanyLocationEdge() {
    }

    public CompanyLocationEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CompanyLocationEdge setCursor(String arg) {
    ...
    */
    ...
    public CompanyLocation getNode() {
        return (CompanyLocation) get("node");
    }

    public CompanyLocationEdge setNode(CompanyLocation arg) {
