                        ...
                        * {
                            ...
                            * {
                                ...
                                * {
                                    ...
                                    */
                                    public class DeliveryCarrierServiceQuery extends Query<DeliveryCarrierServiceQuery> {
                                        DeliveryCarrierServiceQuery(StringBuilder _queryBuilder) {
                                            super(_queryBuilder);
                                        ...
                                        */
                                        public DeliveryCarrierServiceQuery active() {
                                            startField("active");

                                            return this;
                                        }

                                        public class AvailableServicesForCountriesArguments extends Arguments {
                                            AvailableServicesForCountriesArguments(StringBuilder _queryBuilder) {
                                            ...
                                            */
                                            public AvailableServicesForCountriesArguments origins(List<ID> value) {
                                                if (value != null) {
                                                    startArgument("origins");
                                            ...
                                            */
                                            public AvailableServicesForCountriesArguments countryCodes(List<CountryCode> value) {
                                                if (value != null) {
                                        ...
                                        public interface AvailableServicesForCountriesArgumentsDefinition {
                                            void define(AvailableServicesForCountriesArguments args);
                                        }

                                        /**
                                        * The list of services offered for given destinations.
                                        */
                                        public DeliveryCarrierServiceQuery availableServicesForCountries(boolean restOfWorld, DeliveryAvailableServiceQueryDefinition queryDef) {
                                            return availableServicesForCountries(restOfWorld, args -> {}, queryDef);
                                        }

                                        /**
                                        * The list of services offered for given destinations.
                                        */
                                        public DeliveryCarrierServiceQuery availableServicesForCountries(boolean restOfWorld, AvailableServicesForCountriesArgumentsDefinition argsDef, DeliveryAvailableServiceQueryDefinition queryDef) {
                                            startField("availableServicesForCountries");

                                            _queryBuilder.append("(restOfWorld:");
                                            _queryBuilder.append(restOfWorld);

                                            argsDef.define(new AvailableServicesForCountriesArguments(_queryBuilder));

                                            _queryBuilder.append(')');

                                            _queryBuilder.append('{');
                                            queryDef.define(new DeliveryAvailableServiceQuery(_queryBuilder));
                                            _queryBuilder.append('}');
                                        ...
                                        */
                                        public DeliveryCarrierServiceQuery callbackUrl() {
                                        ...
                                        */
                                        public DeliveryCarrierServiceQuery formattedName() {
                                            startField("formattedName");
                                        ...
                                        */
                                        public DeliveryCarrierServiceQuery icon(ImageQueryDefinition queryDef) {
                                            startField("icon");
                                        ...
                                        */
                                        public DeliveryCarrierServiceQuery name() {
                                            startField("name");
                                        ...
                                        */
                                        public DeliveryCarrierServiceQuery supportsServiceDiscovery() {
                                            startField("supportsServiceDiscovery");
