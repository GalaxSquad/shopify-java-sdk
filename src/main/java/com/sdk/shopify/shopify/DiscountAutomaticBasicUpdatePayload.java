...
*/
public class DiscountAutomaticBasicUpdatePayload extends AbstractResponse<DiscountAutomaticBasicUpdatePayload> {
    public DiscountAutomaticBasicUpdatePayload() {
    }

    public DiscountAutomaticBasicUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountAutomaticBasicUpdatePayload";
    }
    ...
    */
    ...
    public DiscountAutomaticBasicUpdatePayload setAutomaticDiscountNode(DiscountAutomaticNode arg) {
    ...
    */
    ...
    public DiscountAutomaticBasicUpdatePayload setUserErrors(List<DiscountUserError> arg) {
