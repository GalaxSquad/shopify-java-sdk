...
*/
public class CartTransformQuery extends Query<CartTransformQuery> {
    CartTransformQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public CartTransformQuery blockOnFailure() {
    ...
    */
    public CartTransformQuery functionId() {
    ...
    */
    public CartTransformQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public CartTransformQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public CartTransformQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public CartTransformQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
