...
*/
public class DiscountCodeAppUpdatePayload extends AbstractResponse<DiscountCodeAppUpdatePayload> {
    public DiscountCodeAppUpdatePayload() {
    }

    public DiscountCodeAppUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeAppUpdatePayload";
    }
    ...
    */
    ...
    public DiscountCodeAppUpdatePayload setCodeAppDiscount(DiscountCodeApp arg) {
    ...
    */
    ...
    public DiscountCodeAppUpdatePayload setUserErrors(List<DiscountUserError> arg) {
