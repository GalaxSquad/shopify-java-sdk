...
*/
public class OrderEditAddCustomItemPayload extends AbstractResponse<OrderEditAddCustomItemPayload> {
    public OrderEditAddCustomItemPayload() {
    }

    public OrderEditAddCustomItemPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "OrderEditAddCustomItemPayload";
    }
    ...
    */
    ...
    public OrderEditAddCustomItemPayload setCalculatedLineItem(CalculatedLineItem arg) {
    ...
    */
    ...
    public OrderEditAddCustomItemPayload setCalculatedOrder(CalculatedOrder arg) {
    ...
    */
    ...
    public OrderEditAddCustomItemPayload setUserErrors(List<UserError> arg) {
