...
*/
public class ReturnRefundPayload extends AbstractResponse<ReturnRefundPayload> {
    public ReturnRefundPayload() {
    }

    public ReturnRefundPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ReturnRefundPayload setRefund(Refund arg) {
    ...
    */
    ...
    public ReturnRefundPayload setUserErrors(List<ReturnUserError> arg) {
