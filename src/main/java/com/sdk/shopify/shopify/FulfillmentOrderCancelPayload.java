...
*/
public class FulfillmentOrderCancelPayload extends AbstractResponse<FulfillmentOrderCancelPayload> {
    public FulfillmentOrderCancelPayload() {
    }

    public FulfillmentOrderCancelPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "FulfillmentOrderCancelPayload";
    }
    ...
    */
    ...
    public FulfillmentOrderCancelPayload setFulfillmentOrder(FulfillmentOrder arg) {
    ...
    */
    ...
    public FulfillmentOrderCancelPayload setReplacementFulfillmentOrder(FulfillmentOrder arg) {
    ...
    */
    ...
    public FulfillmentOrderCancelPayload setUserErrors(List<UserError> arg) {
