...
*/
public class MarketCreatePayload extends AbstractResponse<MarketCreatePayload> {
    public MarketCreatePayload() {
    }

    public MarketCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MarketCreatePayload setMarket(Market arg) {
    ...
    */
    ...
    public MarketCreatePayload setUserErrors(List<MarketUserError> arg) {
