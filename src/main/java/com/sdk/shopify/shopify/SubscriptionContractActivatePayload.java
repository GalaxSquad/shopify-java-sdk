...
*/
public class SubscriptionContractActivatePayload extends AbstractResponse<SubscriptionContractActivatePayload> {
    public SubscriptionContractActivatePayload() {
    }

    public SubscriptionContractActivatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SubscriptionContractActivatePayload setContract(SubscriptionContract arg) {
    ...
    */
    ...
    public SubscriptionContractActivatePayload setUserErrors(List<SubscriptionContractStatusUpdateUserError> arg) {
