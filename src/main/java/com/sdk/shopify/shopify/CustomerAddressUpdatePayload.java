...
*/
public class CustomerAddressUpdatePayload extends AbstractResponse<CustomerAddressUpdatePayload> {
    ...
    */
    ...
    public CustomerAddressUpdatePayload setAddress(MailingAddress arg) {
