...
*/
public class ProductVariantPricePairConnectionQuery extends Query<ProductVariantPricePairConnectionQuery> {
    ...
    */
    public ProductVariantPricePairConnectionQuery nodes(ProductVariantPricePairQueryDefinition queryDef) {
        startField("nodes");
