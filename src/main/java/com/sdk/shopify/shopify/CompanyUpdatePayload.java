...
*/
public class CompanyUpdatePayload extends AbstractResponse<CompanyUpdatePayload> {
    public CompanyUpdatePayload() {
    }

    public CompanyUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CompanyUpdatePayload setCompany(Company arg) {
    ...
    */
    ...
    public CompanyUpdatePayload setUserErrors(List<BusinessCustomerUserError> arg) {
