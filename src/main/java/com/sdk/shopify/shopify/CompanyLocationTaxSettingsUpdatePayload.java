...
*/
public class CompanyLocationTaxSettingsUpdatePayload extends AbstractResponse<CompanyLocationTaxSettingsUpdatePayload> {
    public CompanyLocationTaxSettingsUpdatePayload() {
    }

    public CompanyLocationTaxSettingsUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CompanyLocationTaxSettingsUpdatePayload";
    }
    ...
    */
    ...
    public CompanyLocationTaxSettingsUpdatePayload setCompanyLocation(CompanyLocation arg) {
    ...
    */
    ...
    public CompanyLocationTaxSettingsUpdatePayload setUserErrors(List<BusinessCustomerUserError> arg) {
