...
public class ProductPublishInput implements Serializable {
    private ID id;

    private List<ProductPublicationInput> productPublications;

    public ProductPublishInput(ID id, List<ProductPublicationInput> productPublications) {
        this.id = id;
    ...
    public ProductPublishInput setId(ID id) {
        this.id = id;
        return this;
    }
    ...
    public ProductPublishInput setProductPublications(List<ProductPublicationInput> productPublications) {
        this.productPublications = productPublications;
        return this;
    }
