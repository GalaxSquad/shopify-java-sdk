...
*/
public class DiscountCodeNodeQuery extends Query<DiscountCodeNodeQuery> {
    DiscountCodeNodeQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public DiscountCodeNodeQuery codeDiscount(DiscountCodeQueryDefinition queryDef) {
        startField("codeDiscount");

        _queryBuilder.append('{');
        queryDef.define(new DiscountCodeQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    */
    public DiscountCodeNodeQuery events(EventConnectionQueryDefinition queryDef) {
    ...
    * The paginated list of events associated with the host subject.
    */
    public DiscountCodeNodeQuery events(EventsArgumentsDefinition argsDef, EventConnectionQueryDefinition queryDef) {
        startField("events");
    ...
    */
    public DiscountCodeNodeQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public DiscountCodeNodeQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public DiscountCodeNodeQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public DiscountCodeNodeQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
