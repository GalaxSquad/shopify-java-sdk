...
*/
public class WebhookSubscriptionCreatePayload extends AbstractResponse<WebhookSubscriptionCreatePayload> {
    public WebhookSubscriptionCreatePayload() {
    }

    public WebhookSubscriptionCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public WebhookSubscriptionCreatePayload setUserErrors(List<UserError> arg) {
    ...
    */
    ...
    public WebhookSubscriptionCreatePayload setWebhookSubscription(WebhookSubscription arg) {
