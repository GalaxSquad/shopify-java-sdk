...
public enum TaxExemption {
    /**
    * This customer is exempt from specific taxes for holding a valid COMMERCIAL_FISHERY_EXEMPTION in
    * British Columbia.
    */
    CA_BC_COMMERCIAL_FISHERY_EXEMPTION,

    /**
    * This customer is exempt from specific taxes for holding a valid CONTRACTOR_EXEMPTION in British
    * Columbia.
    */
    CA_BC_CONTRACTOR_EXEMPTION,

    /**
    * This customer is exempt from specific taxes for holding a valid PRODUCTION_AND_MACHINERY_EXEMPTION
    * in British Columbia.
    */
    CA_BC_PRODUCTION_AND_MACHINERY_EXEMPTION,

    /**
    * This customer is exempt from specific taxes for holding a valid RESELLER_EXEMPTION in British
    * Columbia.
    */
    CA_BC_RESELLER_EXEMPTION,

    /**
    * This customer is exempt from specific taxes for holding a valid SUB_CONTRACTOR_EXEMPTION in British
    * Columbia.
    */
    ...
    */
    ...
    /**
    * This customer is exempt from specific taxes for holding a valid COMMERCIAL_FISHERY_EXEMPTION in Nova
    * Scotia.
    */
    ...
    */
    ...
    /**
    * This customer is exempt from specific taxes for holding a valid CONTRACTOR_EXEMPTION in
    * Saskatchewan.
    */
    ...
    */
    ...
    /**
    * This customer is exempt from specific taxes for holding a valid SUB_CONTRACTOR_EXEMPTION in
    * Saskatchewan.
    */
    ...
    */
    ...
    /**
    * This customer is exempt from specific taxes for holding a valid RESELLER_EXEMPTION in North
    * Carolina.
    */
    ...
    */
    ...
    /**
    * This customer is exempt from specific taxes for holding a valid RESELLER_EXEMPTION in South
    * Carolina.
    */
    ...
    */
    ...
    public static TaxExemption fromGraphQl(String value) {
        if (value == null) {
            return null;
        }

        switch (value) {
            case "CA_BC_COMMERCIAL_FISHERY_EXEMPTION": {
                return CA_BC_COMMERCIAL_FISHERY_EXEMPTION;
            }

            case "CA_BC_CONTRACTOR_EXEMPTION": {
                return CA_BC_CONTRACTOR_EXEMPTION;
            }

            case "CA_BC_PRODUCTION_AND_MACHINERY_EXEMPTION": {
                return CA_BC_PRODUCTION_AND_MACHINERY_EXEMPTION;
            }

            case "CA_BC_RESELLER_EXEMPTION": {
                return CA_BC_RESELLER_EXEMPTION;
            }

            case "CA_BC_SUB_CONTRACTOR_EXEMPTION": {
                return CA_BC_SUB_CONTRACTOR_EXEMPTION;
            }

            case "CA_DIPLOMAT_EXEMPTION": {
                return CA_DIPLOMAT_EXEMPTION;
            }

            case "CA_MB_COMMERCIAL_FISHERY_EXEMPTION": {
                return CA_MB_COMMERCIAL_FISHERY_EXEMPTION;
            }

            case "CA_MB_FARMER_EXEMPTION": {
                return CA_MB_FARMER_EXEMPTION;
            }

            case "CA_MB_RESELLER_EXEMPTION": {
                return CA_MB_RESELLER_EXEMPTION;
            }

            case "CA_NS_COMMERCIAL_FISHERY_EXEMPTION": {
                return CA_NS_COMMERCIAL_FISHERY_EXEMPTION;
            }

            case "CA_NS_FARMER_EXEMPTION": {
                return CA_NS_FARMER_EXEMPTION;
            }

            case "CA_ON_PURCHASE_EXEMPTION": {
                return CA_ON_PURCHASE_EXEMPTION;
            }

            case "CA_PE_COMMERCIAL_FISHERY_EXEMPTION": {
                return CA_PE_COMMERCIAL_FISHERY_EXEMPTION;
            }

            case "CA_SK_COMMERCIAL_FISHERY_EXEMPTION": {
                return CA_SK_COMMERCIAL_FISHERY_EXEMPTION;
            }

            case "CA_SK_CONTRACTOR_EXEMPTION": {
                return CA_SK_CONTRACTOR_EXEMPTION;
            }

            case "CA_SK_FARMER_EXEMPTION": {
                return CA_SK_FARMER_EXEMPTION;
            }

            case "CA_SK_PRODUCTION_AND_MACHINERY_EXEMPTION": {
                return CA_SK_PRODUCTION_AND_MACHINERY_EXEMPTION;
            }

            case "CA_SK_RESELLER_EXEMPTION": {
                return CA_SK_RESELLER_EXEMPTION;
            }

            case "CA_SK_SUB_CONTRACTOR_EXEMPTION": {
                return CA_SK_SUB_CONTRACTOR_EXEMPTION;
            }

            case "CA_STATUS_CARD_EXEMPTION": {
                return CA_STATUS_CARD_EXEMPTION;
            }

            case "EU_REVERSE_CHARGE_EXEMPTION_RULE": {
                return EU_REVERSE_CHARGE_EXEMPTION_RULE;
            }

            case "US_AK_RESELLER_EXEMPTION": {
                return US_AK_RESELLER_EXEMPTION;
            }

            case "US_AL_RESELLER_EXEMPTION": {
                return US_AL_RESELLER_EXEMPTION;
            }

            case "US_AR_RESELLER_EXEMPTION": {
                return US_AR_RESELLER_EXEMPTION;
            }

            case "US_AZ_RESELLER_EXEMPTION": {
                return US_AZ_RESELLER_EXEMPTION;
            }

            case "US_CA_RESELLER_EXEMPTION": {
                return US_CA_RESELLER_EXEMPTION;
            }

            case "US_CO_RESELLER_EXEMPTION": {
                return US_CO_RESELLER_EXEMPTION;
            }

            case "US_CT_RESELLER_EXEMPTION": {
                return US_CT_RESELLER_EXEMPTION;
            }

            case "US_DC_RESELLER_EXEMPTION": {
                return US_DC_RESELLER_EXEMPTION;
            }

            case "US_DE_RESELLER_EXEMPTION": {
                return US_DE_RESELLER_EXEMPTION;
            }

            case "US_FL_RESELLER_EXEMPTION": {
                return US_FL_RESELLER_EXEMPTION;
            }

            case "US_GA_RESELLER_EXEMPTION": {
                return US_GA_RESELLER_EXEMPTION;
            }

            case "US_HI_RESELLER_EXEMPTION": {
                return US_HI_RESELLER_EXEMPTION;
            }

            case "US_IA_RESELLER_EXEMPTION": {
                return US_IA_RESELLER_EXEMPTION;
            }

            case "US_ID_RESELLER_EXEMPTION": {
                return US_ID_RESELLER_EXEMPTION;
            }

            case "US_IL_RESELLER_EXEMPTION": {
                return US_IL_RESELLER_EXEMPTION;
            }

            case "US_IN_RESELLER_EXEMPTION": {
                return US_IN_RESELLER_EXEMPTION;
            }

            case "US_KS_RESELLER_EXEMPTION": {
                return US_KS_RESELLER_EXEMPTION;
            }

            case "US_KY_RESELLER_EXEMPTION": {
                return US_KY_RESELLER_EXEMPTION;
            }

            case "US_LA_RESELLER_EXEMPTION": {
                return US_LA_RESELLER_EXEMPTION;
            }

            case "US_MA_RESELLER_EXEMPTION": {
                return US_MA_RESELLER_EXEMPTION;
            }

            case "US_MD_RESELLER_EXEMPTION": {
                return US_MD_RESELLER_EXEMPTION;
            }

            case "US_ME_RESELLER_EXEMPTION": {
                return US_ME_RESELLER_EXEMPTION;
            }

            case "US_MI_RESELLER_EXEMPTION": {
                return US_MI_RESELLER_EXEMPTION;
            }

            case "US_MN_RESELLER_EXEMPTION": {
                return US_MN_RESELLER_EXEMPTION;
            }

            case "US_MO_RESELLER_EXEMPTION": {
                return US_MO_RESELLER_EXEMPTION;
            }

            case "US_MS_RESELLER_EXEMPTION": {
                return US_MS_RESELLER_EXEMPTION;
            }

            case "US_MT_RESELLER_EXEMPTION": {
                return US_MT_RESELLER_EXEMPTION;
            }

            case "US_NC_RESELLER_EXEMPTION": {
                return US_NC_RESELLER_EXEMPTION;
            }

            case "US_ND_RESELLER_EXEMPTION": {
                return US_ND_RESELLER_EXEMPTION;
            }

            case "US_NE_RESELLER_EXEMPTION": {
                return US_NE_RESELLER_EXEMPTION;
            }

            case "US_NH_RESELLER_EXEMPTION": {
                return US_NH_RESELLER_EXEMPTION;
            }

            case "US_NJ_RESELLER_EXEMPTION": {
                return US_NJ_RESELLER_EXEMPTION;
            }

            case "US_NM_RESELLER_EXEMPTION": {
                return US_NM_RESELLER_EXEMPTION;
            }

            case "US_NV_RESELLER_EXEMPTION": {
                return US_NV_RESELLER_EXEMPTION;
            }

            case "US_NY_RESELLER_EXEMPTION": {
                return US_NY_RESELLER_EXEMPTION;
            }

            case "US_OH_RESELLER_EXEMPTION": {
                return US_OH_RESELLER_EXEMPTION;
            }

            case "US_OK_RESELLER_EXEMPTION": {
                return US_OK_RESELLER_EXEMPTION;
            }

            case "US_OR_RESELLER_EXEMPTION": {
                return US_OR_RESELLER_EXEMPTION;
            }

            case "US_PA_RESELLER_EXEMPTION": {
                return US_PA_RESELLER_EXEMPTION;
            }

            case "US_RI_RESELLER_EXEMPTION": {
                return US_RI_RESELLER_EXEMPTION;
            }

            case "US_SC_RESELLER_EXEMPTION": {
                return US_SC_RESELLER_EXEMPTION;
            }

            case "US_SD_RESELLER_EXEMPTION": {
                return US_SD_RESELLER_EXEMPTION;
            }

            case "US_TN_RESELLER_EXEMPTION": {
                return US_TN_RESELLER_EXEMPTION;
            }

            case "US_TX_RESELLER_EXEMPTION": {
                return US_TX_RESELLER_EXEMPTION;
            }

            case "US_UT_RESELLER_EXEMPTION": {
                return US_UT_RESELLER_EXEMPTION;
            }

            case "US_VA_RESELLER_EXEMPTION": {
                return US_VA_RESELLER_EXEMPTION;
            }

            case "US_VT_RESELLER_EXEMPTION": {
                return US_VT_RESELLER_EXEMPTION;
            }

            case "US_WA_RESELLER_EXEMPTION": {
                return US_WA_RESELLER_EXEMPTION;
            }

            case "US_WI_RESELLER_EXEMPTION": {
                return US_WI_RESELLER_EXEMPTION;
            }

            case "US_WV_RESELLER_EXEMPTION": {
                return US_WV_RESELLER_EXEMPTION;
            }

            case "US_WY_RESELLER_EXEMPTION": {
                return US_WY_RESELLER_EXEMPTION;
            }
