...
*/
public class RefundEdge extends AbstractResponse<RefundEdge> {
    public RefundEdge() {
    }

    public RefundEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public RefundEdge setCursor(String arg) {
    ...
    */
    ...
    public Refund getNode() {
        return (Refund) get("node");
    }

    public RefundEdge setNode(Refund arg) {
