...
*/
public class OrderOpenPayload extends AbstractResponse<OrderOpenPayload> {
    public OrderOpenPayload() {
    }

    public OrderOpenPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public OrderOpenPayload setOrder(Order arg) {
    ...
    */
    ...
    public OrderOpenPayload setUserErrors(List<UserError> arg) {
