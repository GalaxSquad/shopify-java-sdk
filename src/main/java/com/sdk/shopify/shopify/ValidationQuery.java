...
*/
public class ValidationQuery extends Query<ValidationQuery> {
    ValidationQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public ValidationQuery blockOnFailure() {
        startField("blockOnFailure");
    ...
    */
    public ValidationQuery enabled() {
        startField("enabled");
    ...
    */
    public ValidationQuery errorHistory(FunctionsErrorHistoryQueryDefinition queryDef) {
    ...
    */
    public ValidationQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public ValidationQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public ValidationQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public ValidationQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
    ...
    */
    public ValidationQuery shopifyFunction(ShopifyFunctionQueryDefinition queryDef) {
