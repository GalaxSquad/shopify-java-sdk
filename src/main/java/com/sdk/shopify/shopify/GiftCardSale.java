...
*/
public class GiftCardSale extends AbstractResponse<GiftCardSale> implements Sale {
    public GiftCardSale() {
    }

    public GiftCardSale(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public GiftCardSale setActionType(SaleActionType arg) {
    ...
    */
    ...
    public GiftCardSale setId(ID arg) {
    ...
    */
    ...
    public GiftCardSale setLineItem(LineItem arg) {
    ...
    */
    ...
    public GiftCardSale setLineType(SaleLineType arg) {
    ...
    */
    ...
    public GiftCardSale setQuantity(Integer arg) {
    ...
    */
    ...
    public GiftCardSale setTaxes(List<SaleTax> arg) {
    ...
    */
    ...
    public GiftCardSale setTotalAmount(MoneyBag arg) {
    ...
    */
    ...
    public GiftCardSale setTotalDiscountAmountAfterTaxes(MoneyBag arg) {
    ...
    */
    ...
    public GiftCardSale setTotalDiscountAmountBeforeTaxes(MoneyBag arg) {
    ...
    */
    ...
    public GiftCardSale setTotalTaxAmount(MoneyBag arg) {
