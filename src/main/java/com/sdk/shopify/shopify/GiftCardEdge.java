...
*/
public class GiftCardEdge extends AbstractResponse<GiftCardEdge> {
    public GiftCardEdge() {
    }

    public GiftCardEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public GiftCardEdge setCursor(String arg) {
    ...
    */
    ...
    public GiftCard getNode() {
        return (GiftCard) get("node");
    }

    public GiftCardEdge setNode(GiftCard arg) {
