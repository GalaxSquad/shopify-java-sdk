...
*/
public class SaleEdge extends AbstractResponse<SaleEdge> {
    public SaleEdge() {
    }

    public SaleEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SaleEdge setCursor(String arg) {
    ...
    */
    ...
    public Sale getNode() {
        return (Sale) get("node");
    }

    public SaleEdge setNode(Sale arg) {
