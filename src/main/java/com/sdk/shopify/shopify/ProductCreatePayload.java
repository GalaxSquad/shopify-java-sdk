...
*/
public class ProductCreatePayload extends AbstractResponse<ProductCreatePayload> {
    public ProductCreatePayload() {
    }

    public ProductCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ProductCreatePayload setProduct(Product arg) {
    ...
    */
    ...
    public ProductCreatePayload setShop(Shop arg) {
    ...
    */
    ...
    public ProductCreatePayload setUserErrors(List<UserError> arg) {
