...
*/
public class InventoryLevelEdge extends AbstractResponse<InventoryLevelEdge> {
    public InventoryLevelEdge() {
    }

    public InventoryLevelEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public InventoryLevelEdge setCursor(String arg) {
    ...
    */
    ...
    public InventoryLevel getNode() {
        return (InventoryLevel) get("node");
    }

    public InventoryLevelEdge setNode(InventoryLevel arg) {
