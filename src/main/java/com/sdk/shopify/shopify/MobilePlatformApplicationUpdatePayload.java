...
*/
public class MobilePlatformApplicationUpdatePayload extends AbstractResponse<MobilePlatformApplicationUpdatePayload> {
    public MobilePlatformApplicationUpdatePayload() {
    }

    public MobilePlatformApplicationUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "MobilePlatformApplicationUpdatePayload";
    }
    ...
    */
    ...
    public MobilePlatformApplicationUpdatePayload setMobilePlatformApplication(MobilePlatformApplication arg) {
    ...
    */
    ...
    public MobilePlatformApplicationUpdatePayload setUserErrors(List<MobilePlatformApplicationUserError> arg) {
