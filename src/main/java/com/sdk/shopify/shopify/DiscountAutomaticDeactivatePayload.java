...
*/
public class DiscountAutomaticDeactivatePayload extends AbstractResponse<DiscountAutomaticDeactivatePayload> {
    public DiscountAutomaticDeactivatePayload() {
    }

    public DiscountAutomaticDeactivatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountAutomaticDeactivatePayload";
    }
    ...
    */
    ...
    public DiscountAutomaticDeactivatePayload setAutomaticDiscountNode(DiscountAutomaticNode arg) {
    ...
    */
    ...
    public DiscountAutomaticDeactivatePayload setUserErrors(List<DiscountUserError> arg) {
