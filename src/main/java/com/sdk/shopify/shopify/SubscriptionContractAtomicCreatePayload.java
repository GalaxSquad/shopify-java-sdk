...
*/
public class SubscriptionContractAtomicCreatePayload extends AbstractResponse<SubscriptionContractAtomicCreatePayload> {
    public SubscriptionContractAtomicCreatePayload() {
    }

    public SubscriptionContractAtomicCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "SubscriptionContractAtomicCreatePayload";
    }
    ...
    */
    ...
    public SubscriptionContractAtomicCreatePayload setContract(SubscriptionContract arg) {
    ...
    */
    ...
    public SubscriptionContractAtomicCreatePayload setUserErrors(List<SubscriptionDraftUserError> arg) {
