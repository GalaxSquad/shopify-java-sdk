...
*/
public class CustomerEdge extends AbstractResponse<CustomerEdge> {
    public CustomerEdge() {
    }

    public CustomerEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CustomerEdge setCursor(String arg) {
    ...
    */
    ...
    public Customer getNode() {
        return (Customer) get("node");
    }

    public CustomerEdge setNode(Customer arg) {
