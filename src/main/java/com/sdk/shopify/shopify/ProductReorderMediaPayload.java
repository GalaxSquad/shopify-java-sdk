...
*/
public class ProductReorderMediaPayload extends AbstractResponse<ProductReorderMediaPayload> {
    public ProductReorderMediaPayload() {
    }

    public ProductReorderMediaPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "ProductReorderMediaPayload";
    }
    ...
    */
    ...
    public ProductReorderMediaPayload setJob(Job arg) {
    ...
    */
    ...
    public ProductReorderMediaPayload setMediaUserErrors(List<MediaUserError> arg) {
