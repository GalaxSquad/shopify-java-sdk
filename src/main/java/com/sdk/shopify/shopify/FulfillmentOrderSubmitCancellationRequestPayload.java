...
*/
public class FulfillmentOrderSubmitCancellationRequestPayload extends AbstractResponse<FulfillmentOrderSubmitCancellationRequestPayload> {
    public FulfillmentOrderSubmitCancellationRequestPayload() {
    }

    public FulfillmentOrderSubmitCancellationRequestPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public FulfillmentOrderSubmitCancellationRequestPayload setFulfillmentOrder(FulfillmentOrder arg) {
    ...
    */
    ...
    public FulfillmentOrderSubmitCancellationRequestPayload setUserErrors(List<UserError> arg) {
