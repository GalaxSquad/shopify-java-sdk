...
public class PriceListParentCreateInput implements Serializable {
    private PriceListAdjustmentInput adjustment;

    private Input<PriceListAdjustmentSettingsInput> settings = Input.undefined();

    public PriceListParentCreateInput(PriceListAdjustmentInput adjustment) {
    ...
    public PriceListParentCreateInput setAdjustment(PriceListAdjustmentInput adjustment) {
        this.adjustment = adjustment;
        return this;
    }
    ...
    public PriceListParentCreateInput setSettings(PriceListAdjustmentSettingsInput settings) {
        this.settings = Input.optional(settings);
        return this;
    }

    public PriceListParentCreateInput setSettingsInput(Input<PriceListAdjustmentSettingsInput> settings) {
        if (settings == null) {
