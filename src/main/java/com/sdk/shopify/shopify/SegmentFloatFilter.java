...
*/
public class SegmentFloatFilter extends AbstractResponse<SegmentFloatFilter> implements SegmentFilter {
    public SegmentFloatFilter() {
    }

    public SegmentFloatFilter(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SegmentFloatFilter setLocalizedName(String arg) {
    ...
    */
    ...
    public SegmentFloatFilter setMaxRange(Double arg) {
    ...
    */
    ...
    public SegmentFloatFilter setMinRange(Double arg) {
    ...
    */
    ...
    public SegmentFloatFilter setMultiValue(Boolean arg) {
    ...
    */
    ...
    public SegmentFloatFilter setQueryName(String arg) {
