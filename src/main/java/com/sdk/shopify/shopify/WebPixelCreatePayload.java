...
*/
public class WebPixelCreatePayload extends AbstractResponse<WebPixelCreatePayload> {
    public WebPixelCreatePayload() {
    }

    public WebPixelCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public WebPixelCreatePayload setUserErrors(List<ErrorsWebPixelUserError> arg) {
    ...
    */
    ...
    public WebPixelCreatePayload setWebPixel(WebPixel arg) {
