...
*/
public class FulfillmentConstraintRuleQuery extends Query<FulfillmentConstraintRuleQuery> {
    FulfillmentConstraintRuleQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public FulfillmentConstraintRuleQuery deliveryMethodTypes() {
        startField("deliveryMethodTypes");
    ...
    */
    public FulfillmentConstraintRuleQuery function(ShopifyFunctionQueryDefinition queryDef) {
        startField("function");
    ...
    */
    public FulfillmentConstraintRuleQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public FulfillmentConstraintRuleQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public FulfillmentConstraintRuleQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public FulfillmentConstraintRuleQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
