...
*/
public class ProductPublishPayload extends AbstractResponse<ProductPublishPayload> {
    public ProductPublishPayload() {
    }

    public ProductPublishPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ProductPublishPayload setProduct(Product arg) {
    ...
    */
    ...
    public ProductPublishPayload setShop(Shop arg) {
    ...
    */
    ...
    public ProductPublishPayload setUserErrors(List<UserError> arg) {
