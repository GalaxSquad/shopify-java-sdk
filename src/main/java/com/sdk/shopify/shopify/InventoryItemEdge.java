...
*/
public class InventoryItemEdge extends AbstractResponse<InventoryItemEdge> {
    public InventoryItemEdge() {
    }

    public InventoryItemEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public InventoryItemEdge setCursor(String arg) {
    ...
    */
    ...
    public InventoryItem getNode() {
        return (InventoryItem) get("node");
    }

    public InventoryItemEdge setNode(InventoryItem arg) {
