...
*/
public class PriceListCreatePayload extends AbstractResponse<PriceListCreatePayload> {
    public PriceListCreatePayload() {
    }

    public PriceListCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public PriceListCreatePayload setPriceList(PriceList arg) {
    ...
    */
    ...
    public PriceListCreatePayload setUserErrors(List<PriceListUserError> arg) {
