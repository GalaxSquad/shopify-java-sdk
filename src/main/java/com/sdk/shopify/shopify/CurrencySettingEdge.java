...
*/
public class CurrencySettingEdge extends AbstractResponse<CurrencySettingEdge> {
    public CurrencySettingEdge() {
    }

    public CurrencySettingEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CurrencySettingEdge setCursor(String arg) {
    ...
    */
    ...
    public CurrencySetting getNode() {
        return (CurrencySetting) get("node");
    }

    public CurrencySettingEdge setNode(CurrencySetting arg) {
