...
*/
public class ReturnApproveRequestPayload extends AbstractResponse<ReturnApproveRequestPayload> {
    public ReturnApproveRequestPayload() {
    }

    public ReturnApproveRequestPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "ReturnApproveRequestPayload";
    }
    ...
    */
    ...
    public ReturnApproveRequestPayload setReturn(Return arg) {
    ...
    */
    ...
    public ReturnApproveRequestPayload setUserErrors(List<ReturnUserError> arg) {
