...
*/
public class CompanyContactRevokeRolesPayload extends AbstractResponse<CompanyContactRevokeRolesPayload> {
    public CompanyContactRevokeRolesPayload() {
    }

    public CompanyContactRevokeRolesPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CompanyContactRevokeRolesPayload setRevokedRoleAssignmentIds(List<ID> arg) {
    ...
    */
    ...
    public CompanyContactRevokeRolesPayload setUserErrors(List<BusinessCustomerUserError> arg) {
