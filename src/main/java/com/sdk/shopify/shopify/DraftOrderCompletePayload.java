...
*/
public class DraftOrderCompletePayload extends AbstractResponse<DraftOrderCompletePayload> {
    public DraftOrderCompletePayload() {
    }

    public DraftOrderCompletePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DraftOrderCompletePayload";
    }
    ...
    */
    ...
    public DraftOrderCompletePayload setDraftOrder(DraftOrder arg) {
    ...
    */
    ...
    public DraftOrderCompletePayload setUserErrors(List<UserError> arg) {
