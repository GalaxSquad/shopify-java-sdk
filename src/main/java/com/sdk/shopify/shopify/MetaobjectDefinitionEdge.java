...
*/
public class MetaobjectDefinitionEdge extends AbstractResponse<MetaobjectDefinitionEdge> {
    public MetaobjectDefinitionEdge() {
    }

    public MetaobjectDefinitionEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MetaobjectDefinitionEdge setCursor(String arg) {
    ...
    */
    ...
    public MetaobjectDefinition getNode() {
        return (MetaobjectDefinition) get("node");
    }

    public MetaobjectDefinitionEdge setNode(MetaobjectDefinition arg) {
