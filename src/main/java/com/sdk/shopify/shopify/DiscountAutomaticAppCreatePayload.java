...
*/
public class DiscountAutomaticAppCreatePayload extends AbstractResponse<DiscountAutomaticAppCreatePayload> {
    public DiscountAutomaticAppCreatePayload() {
    }

    public DiscountAutomaticAppCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountAutomaticAppCreatePayload";
    }
    ...
    */
    ...
    public DiscountAutomaticAppCreatePayload setAutomaticAppDiscount(DiscountAutomaticApp arg) {
    ...
    */
    ...
    public DiscountAutomaticAppCreatePayload setUserErrors(List<DiscountUserError> arg) {
