...
*/
public class BulkOperationCancelPayload extends AbstractResponse<BulkOperationCancelPayload> {
    public BulkOperationCancelPayload() {
    }

    public BulkOperationCancelPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "BulkOperationCancelPayload";
    }
    ...
    */
    ...
    public BulkOperationCancelPayload setBulkOperation(BulkOperation arg) {
    ...
    */
    ...
    public BulkOperationCancelPayload setUserErrors(List<UserError> arg) {
