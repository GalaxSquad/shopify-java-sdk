...
*/
public class SellingPlanGroupAddProductsPayload extends AbstractResponse<SellingPlanGroupAddProductsPayload> {
    public SellingPlanGroupAddProductsPayload() {
    }

    public SellingPlanGroupAddProductsPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SellingPlanGroupAddProductsPayload setSellingPlanGroup(SellingPlanGroup arg) {
    ...
    */
    ...
    public SellingPlanGroupAddProductsPayload setUserErrors(List<SellingPlanGroupUserError> arg) {
