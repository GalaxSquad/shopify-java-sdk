...
*/
public class InventoryItemUpdatePayload extends AbstractResponse<InventoryItemUpdatePayload> {
    public InventoryItemUpdatePayload() {
    }

    public InventoryItemUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public InventoryItemUpdatePayload setInventoryItem(InventoryItem arg) {
    ...
    */
    ...
    public InventoryItemUpdatePayload setUserErrors(List<UserError> arg) {
