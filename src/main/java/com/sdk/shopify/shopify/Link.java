...
*/
public class Link extends AbstractResponse<Link> implements HasPublishedTranslations {
    public Link() {
    }

    public Link(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public Link setLabel(String arg) {
    ...
    */
    ...
    public Link setTranslations(List<Translation> arg) {
