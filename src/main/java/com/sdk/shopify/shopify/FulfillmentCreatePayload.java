...
*/
public class FulfillmentCreatePayload extends AbstractResponse<FulfillmentCreatePayload> {
    public FulfillmentCreatePayload() {
    }

    public FulfillmentCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public FulfillmentCreatePayload setFulfillment(Fulfillment arg) {
    ...
    */
    ...
    public FulfillmentCreatePayload setUserErrors(List<UserError> arg) {
