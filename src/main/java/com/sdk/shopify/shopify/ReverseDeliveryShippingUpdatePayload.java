...
*/
public class ReverseDeliveryShippingUpdatePayload extends AbstractResponse<ReverseDeliveryShippingUpdatePayload> {
    public ReverseDeliveryShippingUpdatePayload() {
    }

    public ReverseDeliveryShippingUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "ReverseDeliveryShippingUpdatePayload";
    }
    ...
    */
    ...
    public ReverseDeliveryShippingUpdatePayload setReverseDelivery(ReverseDelivery arg) {
    ...
    */
    ...
    public ReverseDeliveryShippingUpdatePayload setUserErrors(List<ReturnUserError> arg) {
