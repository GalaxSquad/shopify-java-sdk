...
*/
public class CompanyLocationRevokeTaxExemptionsPayload extends AbstractResponse<CompanyLocationRevokeTaxExemptionsPayload> {
    public CompanyLocationRevokeTaxExemptionsPayload() {
    }

    public CompanyLocationRevokeTaxExemptionsPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CompanyLocationRevokeTaxExemptionsPayload";
    }
    ...
    */
    ...
    public CompanyLocationRevokeTaxExemptionsPayload setCompanyLocation(CompanyLocation arg) {
    ...
    */
    ...
    public CompanyLocationRevokeTaxExemptionsPayload setUserErrors(List<BusinessCustomerUserError> arg) {
