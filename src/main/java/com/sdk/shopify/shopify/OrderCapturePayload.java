...
*/
public class OrderCapturePayload extends AbstractResponse<OrderCapturePayload> {
    public OrderCapturePayload() {
    }

    public OrderCapturePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public OrderCapturePayload setTransaction(OrderTransaction arg) {
    ...
    */
    ...
    public OrderCapturePayload setUserErrors(List<UserError> arg) {
