...
*/
public class FulfillmentOrderEdge extends AbstractResponse<FulfillmentOrderEdge> {
    public FulfillmentOrderEdge() {
    }

    public FulfillmentOrderEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public FulfillmentOrderEdge setCursor(String arg) {
    ...
    */
    ...
    public FulfillmentOrder getNode() {
        return (FulfillmentOrder) get("node");
    }

    public FulfillmentOrderEdge setNode(FulfillmentOrder arg) {
