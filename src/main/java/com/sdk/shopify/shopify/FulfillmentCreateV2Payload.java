...
*/
public class FulfillmentCreateV2Payload extends AbstractResponse<FulfillmentCreateV2Payload> {
    public FulfillmentCreateV2Payload() {
    }

    public FulfillmentCreateV2Payload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "FulfillmentCreateV2Payload";
    }
    ...
    */
    ...
    public FulfillmentCreateV2Payload setFulfillment(Fulfillment arg) {
    ...
    */
    ...
    public FulfillmentCreateV2Payload setUserErrors(List<UserError> arg) {
