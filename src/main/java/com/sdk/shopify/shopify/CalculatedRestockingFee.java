...
*/
public class CalculatedRestockingFee extends AbstractResponse<CalculatedRestockingFee> implements CalculatedReturnFee {
    public CalculatedRestockingFee() {
    }

    public CalculatedRestockingFee(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CalculatedRestockingFee setAmountSet(MoneyBag arg) {
    ...
    */
    ...
    public CalculatedRestockingFee setId(ID arg) {
    ...
    */
    ...
    public CalculatedRestockingFee setPercentage(Double arg) {
