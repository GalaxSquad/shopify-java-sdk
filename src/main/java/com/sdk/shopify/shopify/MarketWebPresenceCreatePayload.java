...
*/
public class MarketWebPresenceCreatePayload extends AbstractResponse<MarketWebPresenceCreatePayload> {
    public MarketWebPresenceCreatePayload() {
    }

    public MarketWebPresenceCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "MarketWebPresenceCreatePayload";
    }
    ...
    */
    ...
    public MarketWebPresenceCreatePayload setMarket(Market arg) {
    ...
    */
    ...
    public MarketWebPresenceCreatePayload setUserErrors(List<MarketUserError> arg) {
