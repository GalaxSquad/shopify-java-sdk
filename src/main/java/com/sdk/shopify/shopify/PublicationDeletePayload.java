...
*/
public class PublicationDeletePayload extends AbstractResponse<PublicationDeletePayload> {
    public PublicationDeletePayload() {
    }

    public PublicationDeletePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "PublicationDeletePayload";
    }
    ...
    */
    ...
    public PublicationDeletePayload setDeletedId(ID arg) {
    ...
    */
    ...
    public PublicationDeletePayload setUserErrors(List<PublicationUserError> arg) {
