...
*/
public class GiftCardCreditTransactionQuery extends Query<GiftCardCreditTransactionQuery> {
    GiftCardCreditTransactionQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public GiftCardCreditTransactionQuery amount(MoneyV2QueryDefinition queryDef) {
        startField("amount");
    ...
    */
    public GiftCardCreditTransactionQuery giftCard(GiftCardQueryDefinition queryDef) {
        startField("giftCard");
    ...
    */
    public GiftCardCreditTransactionQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public GiftCardCreditTransactionQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public GiftCardCreditTransactionQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public GiftCardCreditTransactionQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
    ...
    */
    public GiftCardCreditTransactionQuery note() {
        startField("note");
    ...
    */
    public GiftCardCreditTransactionQuery processedAt() {
