...
public class CheckoutBrandingExpressCheckoutButtonInput implements Serializable {
    ...
    public CheckoutBrandingExpressCheckoutButtonInput setCornerRadius(CheckoutBrandingCornerRadius cornerRadius) {
        this.cornerRadius = Input.optional(cornerRadius);
        return this;
    }

    public CheckoutBrandingExpressCheckoutButtonInput setCornerRadiusInput(Input<CheckoutBrandingCornerRadius> cornerRadius) {
