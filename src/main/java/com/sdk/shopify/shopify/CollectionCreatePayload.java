...
*/
public class CollectionCreatePayload extends AbstractResponse<CollectionCreatePayload> {
    public CollectionCreatePayload() {
    }

    public CollectionCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CollectionCreatePayload";
    }
    ...
    */
    ...
    public CollectionCreatePayload setCollection(Collection arg) {
    ...
    */
    ...
    public CollectionCreatePayload setUserErrors(List<UserError> arg) {
