...
public class CollectionIdentifierInput implements Serializable {
    ...
    public CollectionIdentifierInput setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public CollectionIdentifierInput setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public CollectionIdentifierInput setCustomId(UniqueMetafieldValueInput customId) {
        this.customId = Input.optional(customId);
        return this;
    }

    public CollectionIdentifierInput setCustomIdInput(Input<UniqueMetafieldValueInput> customId) {
        if (customId == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CollectionIdentifierInput setHandle(String handle) {
        this.handle = Input.optional(handle);
        return this;
    }

    public CollectionIdentifierInput setHandleInput(Input<String> handle) {
        if (handle == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.handle = handle;
