...
*/
public class PublicationEdge extends AbstractResponse<PublicationEdge> {
    public PublicationEdge() {
    }

    public PublicationEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public PublicationEdge setCursor(String arg) {
    ...
    */
    ...
    public Publication getNode() {
        return (Publication) get("node");
    }

    public PublicationEdge setNode(Publication arg) {
