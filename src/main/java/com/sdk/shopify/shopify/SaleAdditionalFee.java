...
*/
public class SaleAdditionalFee extends AbstractResponse<SaleAdditionalFee> implements Node {
    public SaleAdditionalFee() {
    }

    public SaleAdditionalFee(JsonObject fields) throws SchemaViolationError {
    ...
    public SaleAdditionalFee(ID id) {
        this();
    ...
    */
    ...
    public SaleAdditionalFee setName(String arg) {
    ...
    */
    ...
    public SaleAdditionalFee setPrice(MoneyBag arg) {
    ...
    */
    ...
    public SaleAdditionalFee setTaxLines(List<TaxLine> arg) {
