...
*/
public class TipSale extends AbstractResponse<TipSale> implements Sale {
    public TipSale() {
    }

    public TipSale(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public TipSale setActionType(SaleActionType arg) {
    ...
    */
    ...
    public TipSale setLineItem(LineItem arg) {
    ...
    */
    ...
    public TipSale setLineType(SaleLineType arg) {
    ...
    */
    ...
    public TipSale setQuantity(Integer arg) {
    ...
    */
    ...
    public TipSale setTaxes(List<SaleTax> arg) {
    ...
    */
    ...
    public TipSale setTotalAmount(MoneyBag arg) {
    ...
    */
    ...
    public TipSale setTotalDiscountAmountAfterTaxes(MoneyBag arg) {
    ...
    */
    ...
    public TipSale setTotalDiscountAmountBeforeTaxes(MoneyBag arg) {
    ...
    */
    ...
    public TipSale setTotalTaxAmount(MoneyBag arg) {
