...
*/
public class ProductVariantLeaveSellingPlanGroupsPayload extends AbstractResponse<ProductVariantLeaveSellingPlanGroupsPayload> {
    public ProductVariantLeaveSellingPlanGroupsPayload() {
    }

    public ProductVariantLeaveSellingPlanGroupsPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ProductVariantLeaveSellingPlanGroupsPayload setProductVariant(ProductVariant arg) {
    ...
    */
    ...
    public ProductVariantLeaveSellingPlanGroupsPayload setUserErrors(List<SellingPlanGroupUserError> arg) {
