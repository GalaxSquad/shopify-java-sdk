...
*/
public class CalculatedDiscountCodeApplication extends AbstractResponse<CalculatedDiscountCodeApplication> implements CalculatedDiscountApplication {
    public CalculatedDiscountCodeApplication() {
    }

    public CalculatedDiscountCodeApplication(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CalculatedDiscountCodeApplication setAllocationMethod(DiscountApplicationAllocationMethod arg) {
    ...
    */
    ...
    public CalculatedDiscountCodeApplication setAppliedTo(DiscountApplicationLevel arg) {
    ...
    */
    ...
    public CalculatedDiscountCodeApplication setCode(String arg) {
    ...
    */
    ...
    public CalculatedDiscountCodeApplication setDescription(String arg) {
    ...
    */
    ...
    public CalculatedDiscountCodeApplication setId(ID arg) {
    ...
    */
    ...
    public CalculatedDiscountCodeApplication setTargetSelection(DiscountApplicationTargetSelection arg) {
    ...
    */
    ...
    public CalculatedDiscountCodeApplication setTargetType(DiscountApplicationTargetType arg) {
    ...
    */
    ...
    public CalculatedDiscountCodeApplication setValue(PricingValue arg) {
