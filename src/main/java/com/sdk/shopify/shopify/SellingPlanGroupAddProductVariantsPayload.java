...
*/
public class SellingPlanGroupAddProductVariantsPayload extends AbstractResponse<SellingPlanGroupAddProductVariantsPayload> {
    public SellingPlanGroupAddProductVariantsPayload() {
    }

    public SellingPlanGroupAddProductVariantsPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "SellingPlanGroupAddProductVariantsPayload";
    }
    ...
    */
    ...
    public SellingPlanGroupAddProductVariantsPayload setSellingPlanGroup(SellingPlanGroup arg) {
    ...
    */
    ...
    public SellingPlanGroupAddProductVariantsPayload setUserErrors(List<SellingPlanGroupUserError> arg) {
