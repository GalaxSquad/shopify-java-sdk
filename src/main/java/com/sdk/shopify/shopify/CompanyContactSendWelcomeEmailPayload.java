...
*/
public class CompanyContactSendWelcomeEmailPayload extends AbstractResponse<CompanyContactSendWelcomeEmailPayload> {
    public CompanyContactSendWelcomeEmailPayload() {
    }

    public CompanyContactSendWelcomeEmailPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CompanyContactSendWelcomeEmailPayload";
    }
    ...
    */
    ...
    public CompanyContactSendWelcomeEmailPayload setCompanyContact(CompanyContact arg) {
    ...
    */
    ...
    public CompanyContactSendWelcomeEmailPayload setUserErrors(List<BusinessCustomerUserError> arg) {
