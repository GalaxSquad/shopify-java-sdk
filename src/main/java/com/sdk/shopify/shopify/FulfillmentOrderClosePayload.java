...
*/
public class FulfillmentOrderClosePayload extends AbstractResponse<FulfillmentOrderClosePayload> {
    public FulfillmentOrderClosePayload() {
    }

    public FulfillmentOrderClosePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "FulfillmentOrderClosePayload";
    }
    ...
    */
    ...
    public FulfillmentOrderClosePayload setFulfillmentOrder(FulfillmentOrder arg) {
    ...
    */
    ...
    public FulfillmentOrderClosePayload setUserErrors(List<UserError> arg) {
