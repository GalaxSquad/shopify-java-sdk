...
*/
public class ReturnLineItemRemoveFromReturnPayload extends AbstractResponse<ReturnLineItemRemoveFromReturnPayload> {
    public ReturnLineItemRemoveFromReturnPayload() {
    }

    public ReturnLineItemRemoveFromReturnPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "ReturnLineItemRemoveFromReturnPayload";
    }
    ...
    */
    ...
    public ReturnLineItemRemoveFromReturnPayload setReturn(Return arg) {
    ...
    */
    ...
    public ReturnLineItemRemoveFromReturnPayload setUserErrors(List<ReturnUserError> arg) {
