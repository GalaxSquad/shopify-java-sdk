...
*/
public class DraftOrderCreateFromOrderPayload extends AbstractResponse<DraftOrderCreateFromOrderPayload> {
    public DraftOrderCreateFromOrderPayload() {
    }

    public DraftOrderCreateFromOrderPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DraftOrderCreateFromOrderPayload";
    }
    ...
    */
    ...
    public DraftOrderCreateFromOrderPayload setDraftOrder(DraftOrder arg) {
    ...
    */
    ...
    public DraftOrderCreateFromOrderPayload setUserErrors(List<UserError> arg) {
