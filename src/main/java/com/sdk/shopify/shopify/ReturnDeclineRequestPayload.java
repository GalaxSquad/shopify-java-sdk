...
*/
public class ReturnDeclineRequestPayload extends AbstractResponse<ReturnDeclineRequestPayload> {
    public ReturnDeclineRequestPayload() {
    }

    public ReturnDeclineRequestPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "ReturnDeclineRequestPayload";
    }
    ...
    */
    ...
    public ReturnDeclineRequestPayload setReturn(Return arg) {
    ...
    */
    ...
    public ReturnDeclineRequestPayload setUserErrors(List<ReturnUserError> arg) {
