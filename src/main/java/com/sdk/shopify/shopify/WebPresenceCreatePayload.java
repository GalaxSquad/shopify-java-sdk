...
*/
public class WebPresenceCreatePayload extends AbstractResponse<WebPresenceCreatePayload> {
    public WebPresenceCreatePayload() {
    }

    public WebPresenceCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "WebPresenceCreatePayload";
    }
    ...
    */
    ...
    public WebPresenceCreatePayload setUserErrors(List<MarketUserError> arg) {
    ...
    */
    ...
    public WebPresenceCreatePayload setWebPresence(MarketWebPresence arg) {
