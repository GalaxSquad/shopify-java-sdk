...
*/
public class ArticleQuery extends Query<ArticleQuery> {
    ...
    */
    ...
    public class CommentsCountArguments extends Arguments {
        CommentsCountArguments(StringBuilder _queryBuilder) {
            super(_queryBuilder, true);
        }
        ...
        * syntax](https://shopify.dev/api/usage/search-syntax).
        */
        public CommentsCountArguments query(String value) {
            if (value != null) {
                startArgument("query");
                Query.appendQuotedString(_queryBuilder, value.toString());
            }
        ...
        */
        public CommentsCountArguments limit(Integer value) {
            if (value != null) {
                startArgument("limit");
                _queryBuilder.append(value);
            }
    ...
    public interface CommentsCountArgumentsDefinition {
        void define(CommentsCountArguments args);
    }

    /**
    * Count of comments. Limited to a maximum of 10000 by default.
    */
    public ArticleQuery commentsCount(CountQueryDefinition queryDef) {
        return commentsCount(args -> {}, queryDef);
    }

    /**
    * Count of comments. Limited to a maximum of 10000 by default.
    */
    public ArticleQuery commentsCount(CommentsCountArgumentsDefinition argsDef, CountQueryDefinition queryDef) {
        startField("commentsCount");

        CommentsCountArguments args = new CommentsCountArguments(_queryBuilder);
        argsDef.define(args);
        CommentsCountArguments.end(args);
    ...
    */
    public ArticleQuery defaultCursor() {
    ...
    */
    public ArticleQuery events(EventConnectionQueryDefinition queryDef) {
    ...
    * The paginated list of events associated with the host subject.
    */
    public ArticleQuery events(EventsArgumentsDefinition argsDef, EventConnectionQueryDefinition queryDef) {
        startField("events");
    ...
    */
    public ArticleQuery isPublished() {
    ...
    */
    public ArticleQuery templateSuffix() {
    ...
    */
    public ArticleQuery translations(String locale, TranslationQueryDefinition queryDef) {
    ...
    * The published translations associated with the resource.
    */
    public ArticleQuery translations(String locale, TranslationsArgumentsDefinition argsDef, TranslationQueryDefinition queryDef) {
