...
*/
public class ArticleAuthorEdge extends AbstractResponse<ArticleAuthorEdge> {
    public ArticleAuthorEdge() {
    }

    public ArticleAuthorEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ArticleAuthorEdge setCursor(String arg) {
    ...
    */
    ...
    public ArticleAuthor getNode() {
        return (ArticleAuthor) get("node");
    }

    public ArticleAuthorEdge setNode(ArticleAuthor arg) {
