...
*/
public class ProductVariantPricePairConnection extends AbstractResponse<ProductVariantPricePairConnection> {
    ...
    public ProductVariantPricePairConnection(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "nodes": {
                    List<ProductVariantPricePair> list1 = new ArrayList<>();
                    for (JsonElement element1 : jsonAsArray(field.getValue(), key)) {
                        list1.add(new ProductVariantPricePair(jsonAsObject(element1, key)));
                    }
    ...
    */
    ...
    /**
    * A list of nodes that are contained in ProductVariantPricePairEdge. You can fetch data about an
    * individual node, or you can follow the edges to fetch data about a collection of related nodes. At
    * each node, you specify the fields that you want to retrieve.
    */

    public List<ProductVariantPricePair> getNodes() {
        return (List<ProductVariantPricePair>) get("nodes");
    }

    public ProductVariantPricePairConnection setNodes(List<ProductVariantPricePair> arg) {
