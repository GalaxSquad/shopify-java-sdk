...
public class CheckoutBrandingSelectInput implements Serializable {
    ...
    public CheckoutBrandingSelectInput setBorder(CheckoutBrandingBorder border) {
        this.border = Input.optional(border);
        return this;
    }

    public CheckoutBrandingSelectInput setBorderInput(Input<CheckoutBrandingBorder> border) {
        if (border == null) {
    ...
    public CheckoutBrandingSelectInput setTypography(CheckoutBrandingTypographyStyleInput typography) {
        this.typography = Input.optional(typography);
        return this;
    }

    public CheckoutBrandingSelectInput setTypographyInput(Input<CheckoutBrandingTypographyStyleInput> typography) {
        if (typography == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
