...
*/
public class DiscountAutomaticBasicCreatePayload extends AbstractResponse<DiscountAutomaticBasicCreatePayload> {
    public DiscountAutomaticBasicCreatePayload() {
    }

    public DiscountAutomaticBasicCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public DiscountAutomaticBasicCreatePayload setAutomaticDiscountNode(DiscountAutomaticNode arg) {
    ...
    */
    ...
    public DiscountAutomaticBasicCreatePayload setUserErrors(List<DiscountUserError> arg) {
