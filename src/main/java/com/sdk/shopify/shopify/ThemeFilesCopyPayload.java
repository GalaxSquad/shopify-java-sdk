...
*/
public class ThemeFilesCopyPayload extends AbstractResponse<ThemeFilesCopyPayload> {
    public ThemeFilesCopyPayload() {
    }

    public ThemeFilesCopyPayload(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            String key = field.getKey();
            String fieldName = getFieldName(key);
            switch (fieldName) {
                case "copiedThemeFiles": {
    ...
    */
    ...
    public List<OnlineStoreThemeFileOperationResult> getCopiedThemeFiles() {
        return (List<OnlineStoreThemeFileOperationResult>) get("copiedThemeFiles");
    }

    public ThemeFilesCopyPayload setCopiedThemeFiles(List<OnlineStoreThemeFileOperationResult> arg) {
        optimisticData.put(getKey("copiedThemeFiles"), arg);
        return this;
    }
    ...
    */
    ...
    public ThemeFilesCopyPayload setUserErrors(List<OnlineStoreThemeFilesUserErrors> arg) {
    ...
    public boolean unwrapsToObject(String key) {
        switch (getFieldName(key)) {
            case "copiedThemeFiles": return true;
