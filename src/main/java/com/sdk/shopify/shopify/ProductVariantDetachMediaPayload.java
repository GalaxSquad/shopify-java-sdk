...
*/
public class ProductVariantDetachMediaPayload extends AbstractResponse<ProductVariantDetachMediaPayload> {
    public ProductVariantDetachMediaPayload() {
    }

    public ProductVariantDetachMediaPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ProductVariantDetachMediaPayload setProduct(Product arg) {
    ...
    */
    ...
    public ProductVariantDetachMediaPayload setProductVariants(List<ProductVariant> arg) {
    ...
    */
    ...
    public ProductVariantDetachMediaPayload setUserErrors(List<MediaUserError> arg) {
