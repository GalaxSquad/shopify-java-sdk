...
*/
public class AppSubscriptionCancelPayload extends AbstractResponse<AppSubscriptionCancelPayload> {
    public AppSubscriptionCancelPayload() {
    }

    public AppSubscriptionCancelPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AppSubscriptionCancelPayload";
    }
    ...
    */
    ...
    public AppSubscriptionCancelPayload setAppSubscription(AppSubscription arg) {
    ...
    */
    ...
    public AppSubscriptionCancelPayload setUserErrors(List<UserError> arg) {
