...
*/
public class ReturnClosePayload extends AbstractResponse<ReturnClosePayload> {
    public ReturnClosePayload() {
    }

    public ReturnClosePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ReturnClosePayload setReturn(Return arg) {
    ...
    */
    ...
    public ReturnClosePayload setUserErrors(List<ReturnUserError> arg) {
