...
public class MetafieldCapabilityUpdateInput implements Serializable {
    ...
    public MetafieldCapabilityUpdateInput setSmartCollectionCondition(MetafieldCapabilitySmartCollectionConditionInput smartCollectionCondition) {
        this.smartCollectionCondition = Input.optional(smartCollectionCondition);
        return this;
    }

    public MetafieldCapabilityUpdateInput setSmartCollectionConditionInput(Input<MetafieldCapabilitySmartCollectionConditionInput> smartCollectionCondition) {
    ...
    public MetafieldCapabilityUpdateInput setAdminFilterable(MetafieldCapabilityAdminFilterableInput adminFilterable) {
        this.adminFilterable = Input.optional(adminFilterable);
        return this;
    }

    public MetafieldCapabilityUpdateInput setAdminFilterableInput(Input<MetafieldCapabilityAdminFilterableInput> adminFilterable) {
    ...
    public MetafieldCapabilityUpdateInput setUniqueValues(MetafieldCapabilityUniqueValuesInput uniqueValues) {
        this.uniqueValues = Input.optional(uniqueValues);
        return this;
    }

    public MetafieldCapabilityUpdateInput setUniqueValuesInput(Input<MetafieldCapabilityUniqueValuesInput> uniqueValues) {
