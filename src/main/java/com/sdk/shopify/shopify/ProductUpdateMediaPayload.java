...
*/
public class ProductUpdateMediaPayload extends AbstractResponse<ProductUpdateMediaPayload> {
    public ProductUpdateMediaPayload() {
    }

    public ProductUpdateMediaPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ProductUpdateMediaPayload setMedia(List<Media> arg) {
    ...
    */
    ...
    public ProductUpdateMediaPayload setMediaUserErrors(List<MediaUserError> arg) {
    ...
    */
    ...
    public ProductUpdateMediaPayload setProduct(Product arg) {
