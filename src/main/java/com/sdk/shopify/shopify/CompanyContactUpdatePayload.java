...
*/
public class CompanyContactUpdatePayload extends AbstractResponse<CompanyContactUpdatePayload> {
    public CompanyContactUpdatePayload() {
    }

    public CompanyContactUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CompanyContactUpdatePayload";
    }
    ...
    */
    ...
    public CompanyContactUpdatePayload setCompanyContact(CompanyContact arg) {
    ...
    */
    ...
    public CompanyContactUpdatePayload setUserErrors(List<BusinessCustomerUserError> arg) {
