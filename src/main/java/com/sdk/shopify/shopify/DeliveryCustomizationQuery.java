...
*/
public class DeliveryCustomizationQuery extends Query<DeliveryCustomizationQuery> {
    DeliveryCustomizationQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public DeliveryCustomizationQuery enabled() {
        startField("enabled");
    ...
    */
    public DeliveryCustomizationQuery errorHistory(FunctionsErrorHistoryQueryDefinition queryDef) {
    ...
    */
    public DeliveryCustomizationQuery functionId() {
    ...
    */
    public DeliveryCustomizationQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public DeliveryCustomizationQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public DeliveryCustomizationQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public DeliveryCustomizationQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
    ...
    */
    public DeliveryCustomizationQuery shopifyFunction(ShopifyFunctionQueryDefinition queryDef) {
    ...
    */
    public DeliveryCustomizationQuery title() {
        startField("title");
