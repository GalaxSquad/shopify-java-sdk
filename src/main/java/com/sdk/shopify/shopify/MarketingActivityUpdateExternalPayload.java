...
*/
public class MarketingActivityUpdateExternalPayload extends AbstractResponse<MarketingActivityUpdateExternalPayload> {
    public MarketingActivityUpdateExternalPayload() {
    }

    public MarketingActivityUpdateExternalPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MarketingActivityUpdateExternalPayload setMarketingActivity(MarketingActivity arg) {
    ...
    */
    ...
    public MarketingActivityUpdateExternalPayload setUserErrors(List<MarketingActivityUserError> arg) {
