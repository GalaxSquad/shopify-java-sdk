...
*/
public class OrderUpdatePayload extends AbstractResponse<OrderUpdatePayload> {
    public OrderUpdatePayload() {
    }

    public OrderUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public OrderUpdatePayload setOrder(Order arg) {
    ...
    */
    ...
    public OrderUpdatePayload setUserErrors(List<UserError> arg) {
