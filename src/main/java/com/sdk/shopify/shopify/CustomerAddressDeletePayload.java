...
*/
public class CustomerAddressDeletePayload extends AbstractResponse<CustomerAddressDeletePayload> {
    ...
    */
    ...
    public CustomerAddressDeletePayload setDeletedAddressId(ID arg) {
