...
*/
public class ArticleConnection extends AbstractResponse<ArticleConnection> {
    ...
    */
    ...
    /**
    * A list of nodes that are contained in ArticleEdge. You can fetch data about an individual node, or
