...
*/
public class MarketLocalizationsRegisterPayload extends AbstractResponse<MarketLocalizationsRegisterPayload> {
    public MarketLocalizationsRegisterPayload() {
    }

    public MarketLocalizationsRegisterPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "MarketLocalizationsRegisterPayload";
    }
    ...
    */
    ...
    public MarketLocalizationsRegisterPayload setMarketLocalizations(List<MarketLocalization> arg) {
    ...
    */
    ...
    public MarketLocalizationsRegisterPayload setUserErrors(List<TranslationUserError> arg) {
