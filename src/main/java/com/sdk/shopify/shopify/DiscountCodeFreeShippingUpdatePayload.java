...
*/
public class DiscountCodeFreeShippingUpdatePayload extends AbstractResponse<DiscountCodeFreeShippingUpdatePayload> {
    public DiscountCodeFreeShippingUpdatePayload() {
    }

    public DiscountCodeFreeShippingUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeFreeShippingUpdatePayload";
    }
    ...
    */
    ...
    public DiscountCodeFreeShippingUpdatePayload setCodeDiscountNode(DiscountCodeNode arg) {
    ...
    */
    ...
    public DiscountCodeFreeShippingUpdatePayload setUserErrors(List<DiscountUserError> arg) {
