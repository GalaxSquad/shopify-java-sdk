...
*/
public class ProductLeaveSellingPlanGroupsPayload extends AbstractResponse<ProductLeaveSellingPlanGroupsPayload> {
    public ProductLeaveSellingPlanGroupsPayload() {
    }

    public ProductLeaveSellingPlanGroupsPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "ProductLeaveSellingPlanGroupsPayload";
    }
    ...
    */
    ...
    public ProductLeaveSellingPlanGroupsPayload setProduct(Product arg) {
    ...
    */
    ...
    public ProductLeaveSellingPlanGroupsPayload setUserErrors(List<SellingPlanGroupUserError> arg) {
