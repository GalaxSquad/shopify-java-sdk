...
*/
public class CompanyLocationCreateTaxRegistrationPayload extends AbstractResponse<CompanyLocationCreateTaxRegistrationPayload> {
    public CompanyLocationCreateTaxRegistrationPayload() {
    }

    public CompanyLocationCreateTaxRegistrationPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CompanyLocationCreateTaxRegistrationPayload";
    }
    ...
    */
    ...
    public CompanyLocationCreateTaxRegistrationPayload setCompanyLocation(CompanyLocation arg) {
    ...
    */
    ...
    public CompanyLocationCreateTaxRegistrationPayload setUserErrors(List<BusinessCustomerUserError> arg) {
