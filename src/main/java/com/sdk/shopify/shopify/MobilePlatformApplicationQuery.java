...
*/
public class MobilePlatformApplicationQuery extends Query<MobilePlatformApplicationQuery> {
    MobilePlatformApplicationQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);

        startField("__typename");
    }

    public MobilePlatformApplicationQuery onAndroidApplication(AndroidApplicationQueryDefinition queryDef) {
        startInlineFragment("AndroidApplication");
        queryDef.define(new AndroidApplicationQuery(_queryBuilder));
        _queryBuilder.append('}');
        return this;
    }

    public MobilePlatformApplicationQuery onAppleApplication(AppleApplicationQueryDefinition queryDef) {
        startInlineFragment("AppleApplication");
        queryDef.define(new AppleApplicationQuery(_queryBuilder));
        _queryBuilder.append('}');
        return this;
    }
}
