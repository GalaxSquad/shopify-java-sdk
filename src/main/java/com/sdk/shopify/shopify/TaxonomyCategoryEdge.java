...
*/
public class TaxonomyCategoryEdge extends AbstractResponse<TaxonomyCategoryEdge> {
    public TaxonomyCategoryEdge() {
    }

    public TaxonomyCategoryEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public TaxonomyCategoryEdge setCursor(String arg) {
    ...
    */
    ...
    public TaxonomyCategory getNode() {
        return (TaxonomyCategory) get("node");
    }

    public TaxonomyCategoryEdge setNode(TaxonomyCategory arg) {
