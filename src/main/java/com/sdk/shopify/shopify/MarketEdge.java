...
*/
public class MarketEdge extends AbstractResponse<MarketEdge> {
    public MarketEdge() {
    }

    public MarketEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MarketEdge setCursor(String arg) {
    ...
    */
    ...
    public Market getNode() {
        return (Market) get("node");
    }

    public MarketEdge setNode(Market arg) {
