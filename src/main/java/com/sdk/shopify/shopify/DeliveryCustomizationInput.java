...
public class DeliveryCustomizationInput implements Serializable {
    ...
    public DeliveryCustomizationInput setFunctionId(String functionId) {
        this.functionId = Input.optional(functionId);
        return this;
    }

    public DeliveryCustomizationInput setFunctionIdInput(Input<String> functionId) {
        if (functionId == null) {
    ...
    public DeliveryCustomizationInput setTitle(String title) {
        this.title = Input.optional(title);
        return this;
    }

    public DeliveryCustomizationInput setTitleInput(Input<String> title) {
        if (title == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.title = title;
    ...
    public DeliveryCustomizationInput setEnabled(Boolean enabled) {
        this.enabled = Input.optional(enabled);
        return this;
    }

    public DeliveryCustomizationInput setEnabledInput(Input<Boolean> enabled) {
        if (enabled == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public DeliveryCustomizationInput setMetafields(List<MetafieldInput> metafields) {
        this.metafields = Input.optional(metafields);
        return this;
    }

    public DeliveryCustomizationInput setMetafieldsInput(Input<List<MetafieldInput>> metafields) {
        if (metafields == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
