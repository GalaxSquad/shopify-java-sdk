...
*/
public class InventoryAdjustQuantitiesPayload extends AbstractResponse<InventoryAdjustQuantitiesPayload> {
    public InventoryAdjustQuantitiesPayload() {
    }

    public InventoryAdjustQuantitiesPayload(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "userErrors": {
                    List<InventoryAdjustQuantitiesUserError> list1 = new ArrayList<>();
                    for (JsonElement element1 : jsonAsArray(field.getValue(), key)) {
                        list1.add(new InventoryAdjustQuantitiesUserError(jsonAsObject(element1, key)));
                    }
    ...
    */
    ...
    public InventoryAdjustQuantitiesPayload setInventoryAdjustmentGroup(InventoryAdjustmentGroup arg) {
    ...
    */
    ...
    public List<InventoryAdjustQuantitiesUserError> getUserErrors() {
        return (List<InventoryAdjustQuantitiesUserError>) get("userErrors");
    }

    public InventoryAdjustQuantitiesPayload setUserErrors(List<InventoryAdjustQuantitiesUserError> arg) {
