...
*/
public class ReturnReopenPayload extends AbstractResponse<ReturnReopenPayload> {
    public ReturnReopenPayload() {
    }

    public ReturnReopenPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ReturnReopenPayload setReturn(Return arg) {
    ...
    */
    ...
    public ReturnReopenPayload setUserErrors(List<ReturnUserError> arg) {
