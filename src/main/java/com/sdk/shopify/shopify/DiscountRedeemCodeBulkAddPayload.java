...
*/
public class DiscountRedeemCodeBulkAddPayload extends AbstractResponse<DiscountRedeemCodeBulkAddPayload> {
    public DiscountRedeemCodeBulkAddPayload() {
    }

    public DiscountRedeemCodeBulkAddPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountRedeemCodeBulkAddPayload";
    }
    ...
    */
    ...
    public DiscountRedeemCodeBulkCreation getBulkCreation() {
        return (DiscountRedeemCodeBulkCreation) get("bulkCreation");
    }

    public DiscountRedeemCodeBulkAddPayload setBulkCreation(DiscountRedeemCodeBulkCreation arg) {
        optimisticData.put(getKey("bulkCreation"), arg);
        return this;
    }
    ...
    */
    ...
    public DiscountRedeemCodeBulkAddPayload setUserErrors(List<DiscountUserError> arg) {
