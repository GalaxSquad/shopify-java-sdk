...
*/
public class SubscriptionDraftCommitPayload extends AbstractResponse<SubscriptionDraftCommitPayload> {
    public SubscriptionDraftCommitPayload() {
    }

    public SubscriptionDraftCommitPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SubscriptionDraftCommitPayload setContract(SubscriptionContract arg) {
    ...
    */
    ...
    public SubscriptionDraftCommitPayload setUserErrors(List<SubscriptionDraftUserError> arg) {
