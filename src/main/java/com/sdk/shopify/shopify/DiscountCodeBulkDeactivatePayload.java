...
*/
public class DiscountCodeBulkDeactivatePayload extends AbstractResponse<DiscountCodeBulkDeactivatePayload> {
    public DiscountCodeBulkDeactivatePayload() {
    }

    public DiscountCodeBulkDeactivatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeBulkDeactivatePayload";
    }
    ...
    */
    ...
    public DiscountCodeBulkDeactivatePayload setJob(Job arg) {
    ...
    */
    ...
    public DiscountCodeBulkDeactivatePayload setUserErrors(List<DiscountUserError> arg) {
