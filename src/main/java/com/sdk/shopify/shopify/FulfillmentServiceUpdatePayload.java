...
*/
public class FulfillmentServiceUpdatePayload extends AbstractResponse<FulfillmentServiceUpdatePayload> {
    public FulfillmentServiceUpdatePayload() {
    }

    public FulfillmentServiceUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "FulfillmentServiceUpdatePayload";
    }
    ...
    */
    ...
    public FulfillmentServiceUpdatePayload setFulfillmentService(FulfillmentService arg) {
    ...
    */
    ...
    public FulfillmentServiceUpdatePayload setUserErrors(List<UserError> arg) {
