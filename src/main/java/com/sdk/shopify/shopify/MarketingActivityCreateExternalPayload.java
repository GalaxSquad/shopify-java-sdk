...
*/
public class MarketingActivityCreateExternalPayload extends AbstractResponse<MarketingActivityCreateExternalPayload> {
    public MarketingActivityCreateExternalPayload() {
    }

    public MarketingActivityCreateExternalPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "MarketingActivityCreateExternalPayload";
    }
    ...
    */
    ...
    public MarketingActivityCreateExternalPayload setMarketingActivity(MarketingActivity arg) {
    ...
    */
    ...
    public MarketingActivityCreateExternalPayload setUserErrors(List<MarketingActivityUserError> arg) {
