...
public class DiscountCustomerSegmentsInput implements Serializable {
    ...
    public DiscountCustomerSegmentsInput setAdd(List<ID> add) {
        this.add = Input.optional(add);
        return this;
    }

    public DiscountCustomerSegmentsInput setAddInput(Input<List<ID>> add) {
        if (add == null) {
    ...
    public DiscountCustomerSegmentsInput setRemove(List<ID> remove) {
        this.remove = Input.optional(remove);
        return this;
    }

    public DiscountCustomerSegmentsInput setRemoveInput(Input<List<ID>> remove) {
        if (remove == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.remove = remove;
