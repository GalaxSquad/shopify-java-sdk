...
*/
public class SubscriptionContractUpdatePayload extends AbstractResponse<SubscriptionContractUpdatePayload> {
    public SubscriptionContractUpdatePayload() {
    }

    public SubscriptionContractUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "SubscriptionContractUpdatePayload";
    }
    ...
    */
    ...
    public SubscriptionContractUpdatePayload setDraft(SubscriptionDraft arg) {
    ...
    */
    ...
    public SubscriptionContractUpdatePayload setUserErrors(List<SubscriptionDraftUserError> arg) {
