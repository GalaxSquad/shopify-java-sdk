...
*/
public class SegmentUpdatePayload extends AbstractResponse<SegmentUpdatePayload> {
    public SegmentUpdatePayload() {
    }

    public SegmentUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SegmentUpdatePayload setSegment(Segment arg) {
    ...
    */
    ...
    public SegmentUpdatePayload setUserErrors(List<UserError> arg) {
