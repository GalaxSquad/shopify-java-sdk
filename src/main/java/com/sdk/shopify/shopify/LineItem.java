...
* Line items contain details about what was purchased, including the product variant, quantity,
* pricing,
* and fulfillment status.
* Use the `LineItem` object to manage the following processes:
* - [Track the quantity of
* items](https://shopify.dev/docs/apps/build/orders-fulfillment/order-management-apps/build-fulfillmen
* t-solutions) ordered, fulfilled, and unfulfilled.
* - [Calculate
...
* - Manage
* [returns](https://shopify.dev/docs/apps/build/orders-fulfillment/returns-apps/build-return-managemen
* t) and
* [exchanges](https://shopify.dev/docs/apps/build/orders-fulfillment/returns-apps/manage-exchanges).
* - Handle [subscriptions](https://shopify.dev/docs/apps/build/purchase-options/subscriptions) and
* recurring orders.
* Line items can also include custom attributes and properties, allowing merchants to add specific
* details
