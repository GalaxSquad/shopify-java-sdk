...
*/
public class ReverseFulfillmentOrderEdge extends AbstractResponse<ReverseFulfillmentOrderEdge> {
    public ReverseFulfillmentOrderEdge() {
    }

    public ReverseFulfillmentOrderEdge(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "ReverseFulfillmentOrderEdge";
    }
    ...
    */
    ...
    public ReverseFulfillmentOrderEdge setCursor(String arg) {
    ...
    */
    ...
    public ReverseFulfillmentOrder getNode() {
        return (ReverseFulfillmentOrder) get("node");
    }

    public ReverseFulfillmentOrderEdge setNode(ReverseFulfillmentOrder arg) {
