...
*/
public class DiscountCodeBulkDeletePayload extends AbstractResponse<DiscountCodeBulkDeletePayload> {
    public DiscountCodeBulkDeletePayload() {
    }

    public DiscountCodeBulkDeletePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeBulkDeletePayload";
    }
    ...
    */
    ...
    public DiscountCodeBulkDeletePayload setJob(Job arg) {
    ...
    */
    ...
    public DiscountCodeBulkDeletePayload setUserErrors(List<DiscountUserError> arg) {
