...
*/
public class ReturnRequestPayload extends AbstractResponse<ReturnRequestPayload> {
    public ReturnRequestPayload() {
    }

    public ReturnRequestPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ReturnRequestPayload setReturn(Return arg) {
    ...
    */
    ...
    public ReturnRequestPayload setUserErrors(List<ReturnUserError> arg) {
