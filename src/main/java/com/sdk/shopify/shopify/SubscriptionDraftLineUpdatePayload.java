...
*/
public class SubscriptionDraftLineUpdatePayload extends AbstractResponse<SubscriptionDraftLineUpdatePayload> {
    public SubscriptionDraftLineUpdatePayload() {
    }

    public SubscriptionDraftLineUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SubscriptionDraftLineUpdatePayload setDraft(SubscriptionDraft arg) {
    ...
    */
    ...
    public SubscriptionDraftLineUpdatePayload setLineUpdated(SubscriptionLine arg) {
    ...
    */
    ...
    public SubscriptionDraftLineUpdatePayload setUserErrors(List<SubscriptionDraftUserError> arg) {
