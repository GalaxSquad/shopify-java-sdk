...
*/
public class InventoryTransferQuery extends Query<InventoryTransferQuery> {
    InventoryTransferQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public InventoryTransferQuery dateCreated() {
    ...
    */
    public InventoryTransferQuery destination(LocationSnapshotQueryDefinition queryDef) {
        startField("destination");

        _queryBuilder.append('{');
        queryDef.define(new LocationSnapshotQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    */
    public InventoryTransferQuery events(EventConnectionQueryDefinition queryDef) {
    ...
    * The list of events associated with the inventory transfer.
    */
    public InventoryTransferQuery events(EventsArgumentsDefinition argsDef, EventConnectionQueryDefinition queryDef) {
        startField("events");
    ...
    */
    public InventoryTransferQuery hasTimelineComment() {
    ...
    */
    public InventoryTransferQuery lineItems(InventoryTransferLineItemConnectionQueryDefinition queryDef) {
    ...
    * The line items associated with the inventory transfer.
    */
    public InventoryTransferQuery lineItems(LineItemsArgumentsDefinition argsDef, InventoryTransferLineItemConnectionQueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new InventoryTransferLineItemConnectionQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * default.
    */
    public InventoryTransferQuery lineItemsCount(CountQueryDefinition queryDef) {
    ...
    * default.
    */
    public InventoryTransferQuery lineItemsCount(LineItemsCountArgumentsDefinition argsDef, CountQueryDefinition queryDef) {
    ...
    */
    public InventoryTransferQuery metafield(String key, MetafieldQueryDefinition queryDef) {
    ...
    * for the purposes of adding and storing additional information.
    */
    public InventoryTransferQuery metafield(String key, MetafieldArgumentsDefinition argsDef, MetafieldQueryDefinition queryDef) {
    ...
    */
    public InventoryTransferQuery metafields(MetafieldConnectionQueryDefinition queryDef) {
    ...
    * that a merchant associates with a Shopify resource.
    */
    public InventoryTransferQuery metafields(MetafieldsArgumentsDefinition argsDef, MetafieldConnectionQueryDefinition queryDef) {
    ...
    */
    public InventoryTransferQuery name() {
        startField("name");
    ...
    */
    public InventoryTransferQuery note() {
        startField("note");
    ...
    * the location link will be nil.
    */
    public InventoryTransferQuery origin(LocationSnapshotQueryDefinition queryDef) {
        startField("origin");
    ...
    */
    public InventoryTransferQuery receivedQuantity() {
        startField("receivedQuantity");
    ...
    */
    public InventoryTransferQuery referenceName() {
        startField("referenceName");

        return this;
    }

    public class ShipmentsArguments extends Arguments {
        ShipmentsArguments(StringBuilder _queryBuilder) {
            super(_queryBuilder, true);
        }
        ...
        * The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).
        */
        public ShipmentsArguments first(Integer value) {
            if (value != null) {
                startArgument("first");
                _queryBuilder.append(value);
            }
        ...
        * [cursor](https://shopify.dev/api/usage/pagination-graphql).
        */
        public ShipmentsArguments after(String value) {
            if (value != null) {
                startArgument("after");
                Query.appendQuotedString(_queryBuilder, value.toString());
            }
        ...
        * The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).
        */
        public ShipmentsArguments last(Integer value) {
            if (value != null) {
                startArgument("last");
                _queryBuilder.append(value);
            }
        ...
        * [cursor](https://shopify.dev/api/usage/pagination-graphql).
        */
        public ShipmentsArguments before(String value) {
            if (value != null) {
                startArgument("before");
                Query.appendQuotedString(_queryBuilder, value.toString());
            }
        ...
        * Reverse the order of the underlying list.
        */
        public ShipmentsArguments reverse(Boolean value) {
            if (value != null) {
                startArgument("reverse");
                _queryBuilder.append(value);
            }
    ...
    public interface ShipmentsArgumentsDefinition {
        void define(ShipmentsArguments args);
    }

    /**
    * The shipments associated with the inventory transfer.
    */
    public InventoryTransferQuery shipments(InventoryShipmentConnectionQueryDefinition queryDef) {
        return shipments(args -> {}, queryDef);
    }

    /**
    * The shipments associated with the inventory transfer.
    */
    public InventoryTransferQuery shipments(ShipmentsArgumentsDefinition argsDef, InventoryShipmentConnectionQueryDefinition queryDef) {
        startField("shipments");

        ShipmentsArguments args = new ShipmentsArguments(_queryBuilder);
        argsDef.define(args);
        ShipmentsArguments.end(args);

        _queryBuilder.append('{');
        queryDef.define(new InventoryShipmentConnectionQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    */
    public InventoryTransferQuery status() {
        startField("status");
    ...
    */
    public InventoryTransferQuery tags() {
        startField("tags");
    ...
    */
    public InventoryTransferQuery totalQuantity() {
