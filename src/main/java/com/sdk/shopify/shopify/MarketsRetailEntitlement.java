...
*/
public class MarketsRetailEntitlement extends AbstractResponse<MarketsRetailEntitlement> {
    public MarketsRetailEntitlement() {
    }

    public MarketsRetailEntitlement(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MarketsRetailEntitlement setCatalogs(MarketsCatalogsEntitlement arg) {
    ...
    */
    ...
    public MarketsRetailEntitlement setEnabled(Boolean arg) {
