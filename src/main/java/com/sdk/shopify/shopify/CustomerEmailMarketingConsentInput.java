...
public class CustomerEmailMarketingConsentInput implements Serializable {
    ...
    public CustomerEmailMarketingConsentInput setSourceLocationId(ID sourceLocationId) {
        this.sourceLocationId = Input.optional(sourceLocationId);
        return this;
    }

    public CustomerEmailMarketingConsentInput setSourceLocationIdInput(Input<ID> sourceLocationId) {
