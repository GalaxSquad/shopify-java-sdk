...
*/
public class MetaobjectUpdatePayload extends AbstractResponse<MetaobjectUpdatePayload> {
    public MetaobjectUpdatePayload() {
    }

    public MetaobjectUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "MetaobjectUpdatePayload";
    }
    ...
    */
    ...
    public MetaobjectUpdatePayload setMetaobject(Metaobject arg) {
    ...
    */
    ...
    public MetaobjectUpdatePayload setUserErrors(List<MetaobjectUserError> arg) {
