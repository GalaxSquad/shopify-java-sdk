...
*/
public class TagsRemovePayload extends AbstractResponse<TagsRemovePayload> {
    public TagsRemovePayload() {
    }

    public TagsRemovePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public TagsRemovePayload setNode(Node arg) {
    ...
    */
    ...
    public TagsRemovePayload setUserErrors(List<UserError> arg) {
