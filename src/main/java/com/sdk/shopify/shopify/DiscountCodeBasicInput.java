...
public class DiscountCodeBasicInput implements Serializable {
    ...
    public DiscountCodeBasicInput setCombinesWith(DiscountCombinesWithInput combinesWith) {
        this.combinesWith = Input.optional(combinesWith);
        return this;
    }

    public DiscountCodeBasicInput setCombinesWithInput(Input<DiscountCombinesWithInput> combinesWith) {
    ...
    public DiscountCodeBasicInput setTitle(String title) {
        this.title = Input.optional(title);
        return this;
    }

    public DiscountCodeBasicInput setTitleInput(Input<String> title) {
        if (title == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.title = title;
    ...
    public DiscountCodeBasicInput setStartsAt(String startsAt) {
        this.startsAt = Input.optional(startsAt);
        return this;
    }

    public DiscountCodeBasicInput setStartsAtInput(Input<String> startsAt) {
        if (startsAt == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public DiscountCodeBasicInput setEndsAt(String endsAt) {
        this.endsAt = Input.optional(endsAt);
        return this;
    }

    public DiscountCodeBasicInput setEndsAtInput(Input<String> endsAt) {
        if (endsAt == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.endsAt = endsAt;
    ...
    public DiscountCodeBasicInput setAppliesOncePerCustomer(Boolean appliesOncePerCustomer) {
        this.appliesOncePerCustomer = Input.optional(appliesOncePerCustomer);
        return this;
    }

    public DiscountCodeBasicInput setAppliesOncePerCustomerInput(Input<Boolean> appliesOncePerCustomer) {
    ...
    public DiscountCodeBasicInput setCode(String code) {
        this.code = Input.optional(code);
        return this;
    }

    public DiscountCodeBasicInput setCodeInput(Input<String> code) {
        if (code == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.code = code;
    ...
    public DiscountCodeBasicInput setCustomerSelection(DiscountCustomerSelectionInput customerSelection) {
        this.customerSelection = Input.optional(customerSelection);
        return this;
    }

    public DiscountCodeBasicInput setCustomerSelectionInput(Input<DiscountCustomerSelectionInput> customerSelection) {
    ...
    public DiscountCodeBasicInput setUsageLimit(Integer usageLimit) {
        this.usageLimit = Input.optional(usageLimit);
        return this;
    }

    public DiscountCodeBasicInput setUsageLimitInput(Input<Integer> usageLimit) {
        if (usageLimit == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public DiscountCodeBasicInput setMinimumRequirement(DiscountMinimumRequirementInput minimumRequirement) {
        this.minimumRequirement = Input.optional(minimumRequirement);
        return this;
    }

    public DiscountCodeBasicInput setMinimumRequirementInput(Input<DiscountMinimumRequirementInput> minimumRequirement) {
    ...
    public DiscountCodeBasicInput setCustomerGets(DiscountCustomerGetsInput customerGets) {
        this.customerGets = Input.optional(customerGets);
        return this;
    }

    public DiscountCodeBasicInput setCustomerGetsInput(Input<DiscountCustomerGetsInput> customerGets) {
    ...
    public DiscountCodeBasicInput setRecurringCycleLimit(Integer recurringCycleLimit) {
        this.recurringCycleLimit = Input.optional(recurringCycleLimit);
        return this;
    }

    public DiscountCodeBasicInput setRecurringCycleLimitInput(Input<Integer> recurringCycleLimit) {
