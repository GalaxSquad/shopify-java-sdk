...
*/
public class DiscountCodeBulkActivatePayload extends AbstractResponse<DiscountCodeBulkActivatePayload> {
    public DiscountCodeBulkActivatePayload() {
    }

    public DiscountCodeBulkActivatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeBulkActivatePayload";
    }
    ...
    */
    ...
    public DiscountCodeBulkActivatePayload setJob(Job arg) {
    ...
    */
    ...
    public DiscountCodeBulkActivatePayload setUserErrors(List<DiscountUserError> arg) {
