...
*/
public class TagsAddPayload extends AbstractResponse<TagsAddPayload> {
    public TagsAddPayload() {
    }

    public TagsAddPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public TagsAddPayload setNode(Node arg) {
    ...
    */
    ...
    public TagsAddPayload setUserErrors(List<UserError> arg) {
