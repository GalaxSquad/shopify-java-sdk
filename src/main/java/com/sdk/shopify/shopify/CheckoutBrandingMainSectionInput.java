...
public class CheckoutBrandingMainSectionInput implements Serializable {
    ...
    public CheckoutBrandingMainSectionInput setColorScheme(CheckoutBrandingColorSchemeSelection colorScheme) {
        this.colorScheme = Input.optional(colorScheme);
        return this;
    }

    public CheckoutBrandingMainSectionInput setColorSchemeInput(Input<CheckoutBrandingColorSchemeSelection> colorScheme) {
        if (colorScheme == null) {
    ...
    public CheckoutBrandingMainSectionInput setBackground(CheckoutBrandingBackground background) {
        this.background = Input.optional(background);
        return this;
    }

    public CheckoutBrandingMainSectionInput setBackgroundInput(Input<CheckoutBrandingBackground> background) {
        if (background == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CheckoutBrandingMainSectionInput setCornerRadius(CheckoutBrandingCornerRadius cornerRadius) {
        this.cornerRadius = Input.optional(cornerRadius);
        return this;
    }

    public CheckoutBrandingMainSectionInput setCornerRadiusInput(Input<CheckoutBrandingCornerRadius> cornerRadius) {
    ...
    public CheckoutBrandingMainSectionInput setBorder(CheckoutBrandingSimpleBorder border) {
        this.border = Input.optional(border);
        return this;
    }

    public CheckoutBrandingMainSectionInput setBorderInput(Input<CheckoutBrandingSimpleBorder> border) {
        if (border == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.border = border;
    ...
    public CheckoutBrandingMainSectionInput setBorderStyle(CheckoutBrandingBorderStyle borderStyle) {
        this.borderStyle = Input.optional(borderStyle);
        return this;
    }

    public CheckoutBrandingMainSectionInput setBorderStyleInput(Input<CheckoutBrandingBorderStyle> borderStyle) {
        if (borderStyle == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CheckoutBrandingMainSectionInput setBorderWidth(CheckoutBrandingBorderWidth borderWidth) {
        this.borderWidth = Input.optional(borderWidth);
        return this;
    }

    public CheckoutBrandingMainSectionInput setBorderWidthInput(Input<CheckoutBrandingBorderWidth> borderWidth) {
        if (borderWidth == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CheckoutBrandingMainSectionInput setShadow(CheckoutBrandingShadow shadow) {
        this.shadow = Input.optional(shadow);
        return this;
    }

    public CheckoutBrandingMainSectionInput setShadowInput(Input<CheckoutBrandingShadow> shadow) {
        if (shadow == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.shadow = shadow;
    ...
    public CheckoutBrandingMainSectionInput setPadding(CheckoutBrandingSpacingKeyword padding) {
        this.padding = Input.optional(padding);
        return this;
    }

    public CheckoutBrandingMainSectionInput setPaddingInput(Input<CheckoutBrandingSpacingKeyword> padding) {
        if (padding == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
