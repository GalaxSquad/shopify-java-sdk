...
*/
public class ChannelEdge extends AbstractResponse<ChannelEdge> {
    public ChannelEdge() {
    }

    public ChannelEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ChannelEdge setCursor(String arg) {
    ...
    */
    ...
    public Channel getNode() {
        return (Channel) get("node");
    }

    public ChannelEdge setNode(Channel arg) {
