...
public class CheckoutBrandingCartLinkInput implements Serializable {
    ...
    public CheckoutBrandingCartLinkInput setVisibility(CheckoutBrandingVisibility visibility) {
        this.visibility = Input.optional(visibility);
        return this;
    }

    public CheckoutBrandingCartLinkInput setVisibilityInput(Input<CheckoutBrandingVisibility> visibility) {
        if (visibility == null) {
