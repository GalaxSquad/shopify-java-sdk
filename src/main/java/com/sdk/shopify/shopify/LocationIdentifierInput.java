...
public class LocationIdentifierInput implements Serializable {
    ...
    public LocationIdentifierInput setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public LocationIdentifierInput setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public LocationIdentifierInput setCustomId(UniqueMetafieldValueInput customId) {
        this.customId = Input.optional(customId);
        return this;
    }

    public LocationIdentifierInput setCustomIdInput(Input<UniqueMetafieldValueInput> customId) {
        if (customId == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
