...
*/
public class ProductJoinSellingPlanGroupsPayload extends AbstractResponse<ProductJoinSellingPlanGroupsPayload> {
    public ProductJoinSellingPlanGroupsPayload() {
    }

    public ProductJoinSellingPlanGroupsPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "ProductJoinSellingPlanGroupsPayload";
    }
    ...
    */
    ...
    public ProductJoinSellingPlanGroupsPayload setProduct(Product arg) {
    ...
    */
    ...
    public ProductJoinSellingPlanGroupsPayload setUserErrors(List<SellingPlanGroupUserError> arg) {
