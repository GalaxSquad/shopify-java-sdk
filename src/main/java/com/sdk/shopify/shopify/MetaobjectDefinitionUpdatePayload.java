...
*/
public class MetaobjectDefinitionUpdatePayload extends AbstractResponse<MetaobjectDefinitionUpdatePayload> {
    public MetaobjectDefinitionUpdatePayload() {
    }

    public MetaobjectDefinitionUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "MetaobjectDefinitionUpdatePayload";
    }
    ...
    */
    ...
    public MetaobjectDefinitionUpdatePayload setMetaobjectDefinition(MetaobjectDefinition arg) {
    ...
    */
    ...
    public MetaobjectDefinitionUpdatePayload setUserErrors(List<MetaobjectUserError> arg) {
