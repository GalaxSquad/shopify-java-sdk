...
*/
public class FileCreatePayload extends AbstractResponse<FileCreatePayload> {
    public FileCreatePayload() {
    }

    public FileCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public FileCreatePayload setFiles(List<File> arg) {
    ...
    */
    ...
    public FileCreatePayload setUserErrors(List<FilesUserError> arg) {
