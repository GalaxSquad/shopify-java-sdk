...
*/
public class RefundCreatePayload extends AbstractResponse<RefundCreatePayload> {
    public RefundCreatePayload() {
    }

    public RefundCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public RefundCreatePayload setOrder(Order arg) {
    ...
    */
    ...
    public RefundCreatePayload setRefund(Refund arg) {
    ...
    */
    ...
    public RefundCreatePayload setUserErrors(List<UserError> arg) {
