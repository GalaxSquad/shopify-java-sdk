...
*/
public class CompanyContactRoleEdge extends AbstractResponse<CompanyContactRoleEdge> {
    public CompanyContactRoleEdge() {
    }

    public CompanyContactRoleEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CompanyContactRoleEdge setCursor(String arg) {
    ...
    */
    ...
    public CompanyContactRole getNode() {
        return (CompanyContactRole) get("node");
    }

    public CompanyContactRoleEdge setNode(CompanyContactRole arg) {
