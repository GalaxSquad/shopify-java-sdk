...
*/
public class OrderEditAgreement extends AbstractResponse<OrderEditAgreement> implements SalesAgreement {
    public OrderEditAgreement() {
    }

    public OrderEditAgreement(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public OrderEditAgreement setApp(App arg) {
    ...
    */
    ...
    public OrderEditAgreement setHappenedAt(String arg) {
    ...
    */
    ...
    public OrderEditAgreement setId(ID arg) {
    ...
    */
    ...
    public OrderEditAgreement setReason(OrderActionType arg) {
    ...
    */
    ...
    public OrderEditAgreement setSales(SaleConnection arg) {
    ...
    */
    ...
    public OrderEditAgreement setUser(StaffMember arg) {
