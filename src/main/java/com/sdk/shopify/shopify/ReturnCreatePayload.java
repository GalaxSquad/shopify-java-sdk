...
*/
public class ReturnCreatePayload extends AbstractResponse<ReturnCreatePayload> {
    public ReturnCreatePayload() {
    }

    public ReturnCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ReturnCreatePayload setReturn(Return arg) {
    ...
    */
    ...
    public ReturnCreatePayload setUserErrors(List<ReturnUserError> arg) {
