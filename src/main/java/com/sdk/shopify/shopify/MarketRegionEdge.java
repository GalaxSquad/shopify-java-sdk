...
*/
public class MarketRegionEdge extends AbstractResponse<MarketRegionEdge> {
    public MarketRegionEdge() {
    }

    public MarketRegionEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MarketRegionEdge setCursor(String arg) {
    ...
    */
    ...
    public MarketRegion getNode() {
        return (MarketRegion) get("node");
    }

    public MarketRegionEdge setNode(MarketRegion arg) {
