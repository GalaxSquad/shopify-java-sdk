...
*/
public class GiftCardDebitTransaction extends AbstractResponse<GiftCardDebitTransaction> implements GiftCardTransaction, HasMetafields, Node {
    public GiftCardDebitTransaction() {
    }

    public GiftCardDebitTransaction(JsonObject fields) throws SchemaViolationError {
    ...
    public GiftCardDebitTransaction(ID id) {
        this();
    ...
    */
    ...
    public GiftCardDebitTransaction setAmount(MoneyV2 arg) {
    ...
    */
    ...
    public GiftCardDebitTransaction setGiftCard(GiftCard arg) {
    ...
    */
    ...
    public GiftCardDebitTransaction setMetafield(Metafield arg) {
    ...
    */
    ...
    public GiftCardDebitTransaction setMetafields(MetafieldConnection arg) {
    ...
    */
    ...
    public GiftCardDebitTransaction setNote(String arg) {
    ...
    */
    ...
    public GiftCardDebitTransaction setProcessedAt(String arg) {
