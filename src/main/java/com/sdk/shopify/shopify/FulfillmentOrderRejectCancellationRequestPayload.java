...
*/
public class FulfillmentOrderRejectCancellationRequestPayload extends AbstractResponse<FulfillmentOrderRejectCancellationRequestPayload> {
    public FulfillmentOrderRejectCancellationRequestPayload() {
    }

    public FulfillmentOrderRejectCancellationRequestPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public FulfillmentOrderRejectCancellationRequestPayload setFulfillmentOrder(FulfillmentOrder arg) {
    ...
    */
    ...
    public FulfillmentOrderRejectCancellationRequestPayload setUserErrors(List<UserError> arg) {
