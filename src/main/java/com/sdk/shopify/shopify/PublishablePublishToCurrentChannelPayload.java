...
*/
public class PublishablePublishToCurrentChannelPayload extends AbstractResponse<PublishablePublishToCurrentChannelPayload> {
    public PublishablePublishToCurrentChannelPayload() {
    }

    public PublishablePublishToCurrentChannelPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "PublishablePublishToCurrentChannelPayload";
    }
    ...
    */
    ...
    public PublishablePublishToCurrentChannelPayload setPublishable(Publishable arg) {
    ...
    */
    ...
    public PublishablePublishToCurrentChannelPayload setShop(Shop arg) {
    ...
    */
    ...
    public PublishablePublishToCurrentChannelPayload setUserErrors(List<UserError> arg) {
