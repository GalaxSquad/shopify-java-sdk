...
*/
public class BlogQuery extends Query<BlogQuery> {
    ...
    */
    public BlogQuery commentPolicy() {
        startField("commentPolicy");
    ...
    */
    public BlogQuery events(EventConnectionQueryDefinition queryDef) {
    ...
    * The paginated list of events associated with the host subject.
    */
    public BlogQuery events(EventsArgumentsDefinition argsDef, EventConnectionQueryDefinition queryDef) {
        startField("events");
    ...
    * service.
    */
    public BlogQuery feed(BlogFeedQueryDefinition queryDef) {
        startField("feed");

        _queryBuilder.append('{');
        queryDef.define(new BlogFeedQuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    */
    public BlogQuery templateSuffix() {
    ...
    */
    public BlogQuery translations(String locale, TranslationQueryDefinition queryDef) {
    ...
    * The published translations associated with the resource.
    */
    public BlogQuery translations(String locale, TranslationsArgumentsDefinition argsDef, TranslationQueryDefinition queryDef) {
