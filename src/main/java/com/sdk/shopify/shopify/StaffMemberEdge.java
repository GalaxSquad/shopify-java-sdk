...
*/
public class StaffMemberEdge extends AbstractResponse<StaffMemberEdge> {
    public StaffMemberEdge() {
    }

    public StaffMemberEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public StaffMemberEdge setCursor(String arg) {
    ...
    */
    ...
    public StaffMember getNode() {
        return (StaffMember) get("node");
    }

    public StaffMemberEdge setNode(StaffMember arg) {
