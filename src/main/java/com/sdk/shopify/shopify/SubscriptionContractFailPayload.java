...
*/
public class SubscriptionContractFailPayload extends AbstractResponse<SubscriptionContractFailPayload> {
    public SubscriptionContractFailPayload() {
    }

    public SubscriptionContractFailPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public SubscriptionContractFailPayload setContract(SubscriptionContract arg) {
    ...
    */
    ...
    public SubscriptionContractFailPayload setUserErrors(List<SubscriptionContractStatusUpdateUserError> arg) {
