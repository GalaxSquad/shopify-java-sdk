...
*/
public class CompanyLocationCreatePayload extends AbstractResponse<CompanyLocationCreatePayload> {
    public CompanyLocationCreatePayload() {
    }

    public CompanyLocationCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CompanyLocationCreatePayload";
    }
    ...
    */
    ...
    public CompanyLocationCreatePayload setCompanyLocation(CompanyLocation arg) {
    ...
    */
    ...
    public CompanyLocationCreatePayload setUserErrors(List<BusinessCustomerUserError> arg) {
