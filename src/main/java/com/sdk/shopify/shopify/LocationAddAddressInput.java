...
public class LocationAddAddressInput implements Serializable {
    ...
    public LocationAddAddressInput(CountryCode countryCode) {
    ...
    public LocationAddAddressInput setCountryCode(CountryCode countryCode) {
        this.countryCode = countryCode;
        return this;
    }
    ...
    public LocationAddAddressInput setAddress1(String address1) {
        this.address1 = Input.optional(address1);
        return this;
    }

    public LocationAddAddressInput setAddress1Input(Input<String> address1) {
        if (address1 == null) {
    ...
    public LocationAddAddressInput setAddress2(String address2) {
        this.address2 = Input.optional(address2);
        return this;
    }

    public LocationAddAddressInput setAddress2Input(Input<String> address2) {
        if (address2 == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public LocationAddAddressInput setCity(String city) {
        this.city = Input.optional(city);
        return this;
    }

    public LocationAddAddressInput setCityInput(Input<String> city) {
        if (city == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.city = city;
    ...
    public LocationAddAddressInput setPhone(String phone) {
        this.phone = Input.optional(phone);
        return this;
    }

    public LocationAddAddressInput setPhoneInput(Input<String> phone) {
        if (phone == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.phone = phone;
    ...
    public LocationAddAddressInput setZip(String zip) {
        this.zip = Input.optional(zip);
        return this;
    }

    public LocationAddAddressInput setZipInput(Input<String> zip) {
        if (zip == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.zip = zip;
    ...
    public LocationAddAddressInput setProvinceCode(String provinceCode) {
        this.provinceCode = Input.optional(provinceCode);
        return this;
    }

    public LocationAddAddressInput setProvinceCodeInput(Input<String> provinceCode) {
