...
*/
public class DraftOrderInvoiceSendPayload extends AbstractResponse<DraftOrderInvoiceSendPayload> {
    public DraftOrderInvoiceSendPayload() {
    }

    public DraftOrderInvoiceSendPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DraftOrderInvoiceSendPayload";
    }
    ...
    */
    ...
    public DraftOrderInvoiceSendPayload setDraftOrder(DraftOrder arg) {
    ...
    */
    ...
    public DraftOrderInvoiceSendPayload setUserErrors(List<UserError> arg) {
