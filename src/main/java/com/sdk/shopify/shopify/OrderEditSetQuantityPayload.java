...
*/
public class OrderEditSetQuantityPayload extends AbstractResponse<OrderEditSetQuantityPayload> {
    public OrderEditSetQuantityPayload() {
    }

    public OrderEditSetQuantityPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "OrderEditSetQuantityPayload";
    }
    ...
    */
    ...
    public OrderEditSetQuantityPayload setCalculatedLineItem(CalculatedLineItem arg) {
    ...
    */
    ...
    public OrderEditSetQuantityPayload setCalculatedOrder(CalculatedOrder arg) {
    ...
    */
    ...
    public OrderEditSetQuantityPayload setUserErrors(List<UserError> arg) {
