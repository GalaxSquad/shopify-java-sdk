...
*/
public class UnknownMobilePlatformApplication extends AbstractResponse<UnknownMobilePlatformApplication> implements MobilePlatformApplication {
    public UnknownMobilePlatformApplication() {
    }

    public UnknownMobilePlatformApplication(JsonObject fields) throws SchemaViolationError {
    ...
    public static MobilePlatformApplication create(JsonObject fields) throws SchemaViolationError {
        String typeName = fields.getAsJsonPrimitive("__typename").getAsString();
        switch (typeName) {
            case "AndroidApplication": {
                return new AndroidApplication(fields);
            }

            case "AppleApplication": {
                return new AppleApplication(fields);
            }

            default: {
                return new UnknownMobilePlatformApplication(fields);
            }
        }
    }
