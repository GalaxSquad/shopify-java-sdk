...
*/
public class AddAllProductsOperation extends AbstractResponse<AddAllProductsOperation> implements Node, PublicationOperation, ResourceOperation {
    public AddAllProductsOperation() {
    }

    public AddAllProductsOperation(JsonObject fields) throws SchemaViolationError {
    ...
    public AddAllProductsOperation(ID id) {
        this();
        optimisticData.put("id", id);
    }

    public String getGraphQlTypeName() {
        return "AddAllProductsOperation";
    }
    ...
    */
    ...
    public AddAllProductsOperation setProcessedRowCount(Integer arg) {
    ...
    */
    ...
    public AddAllProductsOperation setRowCount(RowCount arg) {
    ...
    */
    ...
    public AddAllProductsOperation setStatus(ResourceOperationStatus arg) {
