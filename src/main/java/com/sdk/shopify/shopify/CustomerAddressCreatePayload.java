...
*/
public class CustomerAddressCreatePayload extends AbstractResponse<CustomerAddressCreatePayload> {
    ...
    */
    ...
    public CustomerAddressCreatePayload setAddress(MailingAddress arg) {
