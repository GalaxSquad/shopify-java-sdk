...
*/
public class ValidationDeletePayload extends AbstractResponse<ValidationDeletePayload> {
    public ValidationDeletePayload() {
    }

    public ValidationDeletePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ValidationDeletePayload setDeletedId(ID arg) {
    ...
    */
    ...
    public ValidationDeletePayload setUserErrors(List<ValidationUserError> arg) {
