...
*/
public class MarketWebPresenceUpdatePayload extends AbstractResponse<MarketWebPresenceUpdatePayload> {
    public MarketWebPresenceUpdatePayload() {
    }

    public MarketWebPresenceUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public MarketWebPresenceUpdatePayload setMarket(Market arg) {
    ...
    */
    ...
    public MarketWebPresenceUpdatePayload setUserErrors(List<MarketUserError> arg) {
