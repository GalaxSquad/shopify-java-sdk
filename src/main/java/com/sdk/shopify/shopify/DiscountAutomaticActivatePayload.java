...
*/
public class DiscountAutomaticActivatePayload extends AbstractResponse<DiscountAutomaticActivatePayload> {
    public DiscountAutomaticActivatePayload() {
    }

    public DiscountAutomaticActivatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountAutomaticActivatePayload";
    }
    ...
    */
    ...
    public DiscountAutomaticActivatePayload setAutomaticDiscountNode(DiscountAutomaticNode arg) {
    ...
    */
    ...
    public DiscountAutomaticActivatePayload setUserErrors(List<DiscountUserError> arg) {
