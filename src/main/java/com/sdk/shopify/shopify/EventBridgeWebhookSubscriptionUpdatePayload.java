...
*/
public class EventBridgeWebhookSubscriptionUpdatePayload extends AbstractResponse<EventBridgeWebhookSubscriptionUpdatePayload> {
    public EventBridgeWebhookSubscriptionUpdatePayload() {
    }

    public EventBridgeWebhookSubscriptionUpdatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public EventBridgeWebhookSubscriptionUpdatePayload setUserErrors(List<UserError> arg) {
    ...
    */
    ...
    public EventBridgeWebhookSubscriptionUpdatePayload setWebhookSubscription(WebhookSubscription arg) {
