...
*/
public class DiscountCodeActivatePayload extends AbstractResponse<DiscountCodeActivatePayload> {
    public DiscountCodeActivatePayload() {
    }

    public DiscountCodeActivatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "DiscountCodeActivatePayload";
    }
    ...
    */
    ...
    public DiscountCodeActivatePayload setCodeDiscountNode(DiscountCodeNode arg) {
    ...
    */
    ...
    public DiscountCodeActivatePayload setUserErrors(List<DiscountUserError> arg) {
