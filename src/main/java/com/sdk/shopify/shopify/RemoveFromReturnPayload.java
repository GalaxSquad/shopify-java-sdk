...
*/
public class RemoveFromReturnPayload extends AbstractResponse<RemoveFromReturnPayload> {
    public RemoveFromReturnPayload() {
    }

    public RemoveFromReturnPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "RemoveFromReturnPayload";
    }
    ...
    */
    ...
    public RemoveFromReturnPayload setReturn(Return arg) {
    ...
    */
    ...
    public RemoveFromReturnPayload setUserErrors(List<ReturnUserError> arg) {
