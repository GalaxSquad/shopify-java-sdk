...
public class MarketWebPresenceCreateInput implements Serializable {
    ...
    public MarketWebPresenceCreateInput(String defaultLocale) {
    ...
    public MarketWebPresenceCreateInput setDefaultLocale(String defaultLocale) {
        this.defaultLocale = defaultLocale;
        return this;
    }
    ...
    public MarketWebPresenceCreateInput setDomainId(ID domainId) {
        this.domainId = Input.optional(domainId);
        return this;
    }

    public MarketWebPresenceCreateInput setDomainIdInput(Input<ID> domainId) {
        if (domainId == null) {
    ...
    public MarketWebPresenceCreateInput setAlternateLocales(List<String> alternateLocales) {
        this.alternateLocales = Input.optional(alternateLocales);
        return this;
    }

    public MarketWebPresenceCreateInput setAlternateLocalesInput(Input<List<String>> alternateLocales) {
    ...
    public MarketWebPresenceCreateInput setSubfolderSuffix(String subfolderSuffix) {
        this.subfolderSuffix = Input.optional(subfolderSuffix);
        return this;
    }

    public MarketWebPresenceCreateInput setSubfolderSuffixInput(Input<String> subfolderSuffix) {
