...
public class CheckoutBrandingBuyerJourneyInput implements Serializable {
    ...
    public CheckoutBrandingBuyerJourneyInput setVisibility(CheckoutBrandingVisibility visibility) {
        this.visibility = Input.optional(visibility);
        return this;
    }

    public CheckoutBrandingBuyerJourneyInput setVisibilityInput(Input<CheckoutBrandingVisibility> visibility) {
        if (visibility == null) {
