...
*/
public class MetaobjectCreatePayload extends AbstractResponse<MetaobjectCreatePayload> {
    public MetaobjectCreatePayload() {
    }

    public MetaobjectCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "MetaobjectCreatePayload";
    }
    ...
    */
    ...
    public MetaobjectCreatePayload setMetaobject(Metaobject arg) {
    ...
    */
    ...
    public MetaobjectCreatePayload setUserErrors(List<MetaobjectUserError> arg) {
