...
*/
public class CompanyLocationRevokeTaxRegistrationPayload extends AbstractResponse<CompanyLocationRevokeTaxRegistrationPayload> {
    public CompanyLocationRevokeTaxRegistrationPayload() {
    }

    public CompanyLocationRevokeTaxRegistrationPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CompanyLocationRevokeTaxRegistrationPayload";
    }
    ...
    */
    ...
    public CompanyLocationRevokeTaxRegistrationPayload setCompanyLocation(CompanyLocation arg) {
    ...
    */
    ...
    public CompanyLocationRevokeTaxRegistrationPayload setUserErrors(List<BusinessCustomerUserError> arg) {
