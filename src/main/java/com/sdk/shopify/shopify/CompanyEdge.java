...
*/
public class CompanyEdge extends AbstractResponse<CompanyEdge> {
    public CompanyEdge() {
    }

    public CompanyEdge(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CompanyEdge setCursor(String arg) {
    ...
    */
    ...
    public Company getNode() {
        return (Company) get("node");
    }

    public CompanyEdge setNode(Company arg) {
