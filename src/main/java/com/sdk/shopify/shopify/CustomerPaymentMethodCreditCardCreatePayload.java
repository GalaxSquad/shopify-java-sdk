...
*/
public class CustomerPaymentMethodCreditCardCreatePayload extends AbstractResponse<CustomerPaymentMethodCreditCardCreatePayload> {
    public CustomerPaymentMethodCreditCardCreatePayload() {
    }

    public CustomerPaymentMethodCreditCardCreatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "CustomerPaymentMethodCreditCardCreatePayload";
    }
    ...
    */
    ...
    public CustomerPaymentMethodCreditCardCreatePayload setCustomerPaymentMethod(CustomerPaymentMethod arg) {
    ...
    */
    ...
    public CustomerPaymentMethodCreditCardCreatePayload setProcessing(Boolean arg) {
    ...
    */
    ...
    public CustomerPaymentMethodCreditCardCreatePayload setUserErrors(List<UserError> arg) {
